...
class ST_SYST_TOOLS_LOG_007(unittest.TestCase):
	logfile = os.getcwd() + "/ST_SYST_TOOLS_LOG_007.log"
	...
	def test_logcatToSdcard(self):
		self.log("ST_SYST_TOOLS_LOG_007: start!")
		if not self.logcatToSdcard():
			self.log("ST_SYST_TOOLS_LOG_007: fail")
			print "ST_SYST_TOOLS_LOG_007: fail"
		else:
			self.log("ST_SYST_TOOLS_LOG_007: pass")
			print "ST_SYST_TOOLS_LOG_007: pass"
		self.log("ST_SYST_TOOLS_LOG_007: end!")
		
if __name__ == '__main__':
	if os.path.exists(r'ST_SYST_TOOLS_LOG_007.log'):
		os.remove(r'ST_SYST_TOOLS_LOG_007.log')
