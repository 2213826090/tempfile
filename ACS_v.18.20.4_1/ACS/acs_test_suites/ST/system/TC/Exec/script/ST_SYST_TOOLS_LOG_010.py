...
class ST_SYST_TOOLS_LOG_010(unittest.TestCase):
	logfile = os.getcwd() + "/ST_SYST_TOOLS_LOG_010.log"
	...
	def test_emmc_aplogTimestamp(self):
		self.log("ST_SYST_TOOLS_LOG_010: start!")
		if not self.emmc_aplogTimestamp():
			self.log("ST_SYST_TOOLS_LOG_010: fail")
			print "ST_SYST_TOOLS_LOG_010: fail"
		else:
			self.log("ST_SYST_TOOLS_LOG_010: PASS")	
			print "ST_SYST_TOOLS_LOG_010: pass"
		self.log("ST_SYST_TOOLS_LOG_010: end!")
		
if __name__ == '__main__':
	if os.path.exists(r'ST_SYST_TOOLS_LOG_010.log'):
		os.remove(r'ST_SYST_TOOLS_LOG_010.log')
	os.system("adb shell ls /logs/aplog > 1.txt")
	file = open("1.txt")
	line = file.readlines()
	file.close()
