...
class ST_SYST_TOOLS_LOG_130(unittest.TestCase):
	logfile = os.getcwd() + "/ST_SYST_TOOLS_LOG_130.log"
	...
	def test_logcatToData(self):
		self.log("ST_SYST_TOOLS_LOG_130: start!")
		if not self.logcatToData():
			self.log("ST_SYST_TOOLS_LOG_130: fail")
			print "ST_SYST_TOOLS_LOG_130: fail"
		else:
			self.log("ST_SYST_TOOLS_LOG_130: pass")
			print "ST_SYST_TOOLS_LOG_130: pass"
		self.log("ST_SYST_TOOLS_LOG_130: end!")
		
if __name__ == '__main__':
	if os.path.exists(r'ST_SYST_TOOLS_LOG_130.log'):
		os.remove(r'ST_SYST_TOOLS_LOG_130.log')
