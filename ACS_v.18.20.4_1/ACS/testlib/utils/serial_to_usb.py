"""
    This library was extracted from ATF library set.
    AtfSettings.LOGGER logic was removed from the original file. Instead
    a verbose parameter was introduced to the class for printing.
"""
