#######################################################################
#
# @filename:    AOSP_Android_N_Car_Application-Menu.Dialer_A_number_Delete.py
# @description: entering the number and deleting using dialer pad
...
ui_steps.click_button_common(view_to_find={"index":"1"},view_to_check={"text":"Dial a number"},serial=serial)()
...
ui_steps.click_button_common(view_to_find={"resourceId":"com.android.car.dialer:id/delete"},view_to_check={"text":"123456"},serial=serial)()
ui_steps.click_button_common(view_to_find={"resourceId":"com.android.car.dialer:id/delete"},view_to_check={"text":"12345"},serial=serial)()
ui_steps.click_button_common(view_to_find={"resourceId":"com.android.car.dialer:id/delete"},view_to_check={"text":"1234"},serial=serial)()
ui_steps.click_button_common(view_to_find={"resourceId":"com.android.car.dialer:id/delete"},view_to_check={"text":"123"},serial=serial)()
ui_steps.click_button_common(view_to_find={"resourceId":"com.android.car.dialer:id/delete"},view_to_check={"text":"12"},serial=serial)()
ui_steps.click_button_common(view_to_find={"resourceId":"com.android.car.dialer:id/delete"},view_to_check={"text":"1"},serial=serial)()
ui_steps.click_button_common(view_to_find={"resourceId":"com.android.car.dialer:id/delete"},view_to_check={"text":""},serial=serial)()
