...
#######################################################################
#
# @filename:  AOSP_Android_Applications_DialerApp_Menu_Call_History.py
# @description: Click back key in the Dialer Menu
...
ui_steps.click_button_common(view_to_find={"text":"Call History"},view_to_check={"text":"Call History"},serial=serial)()
ui_steps.click_button_common(view_to_find={"className":"android.widget.LinearLayout"},second_view_to_find={"index":"0"},view_to_check={"text":"Dialing"},serial=serial)()
