...
#######################################################################
#
# @filename:  AOSP_Android_Applications_DialerApp_Menu.Dialer_A_Number_Call_Valid_Number.py
# @description: Dial a valid number via BT Phone
...
ui_steps.click_button(view_to_find={"text":"7"},serial=serial)()
ui_steps.click_button(view_to_find={"text":"6"},serial=serial)()
ui_steps.click_button(view_to_find={"text":"2"},serial=serial)()
ui_steps.click_button(view_to_find={"text":"5"},serial=serial)()
ui_steps.click_button(view_to_find={"text":"0"},serial=serial)()
ui_steps.click_button(view_to_find={"text":"6"},serial=serial)()
ui_steps.click_button(view_to_find={"text":"3"},serial=serial)()
ui_steps.click_button(view_to_find={"text":"7"},serial=serial)()
ui_steps.click_button(view_to_find={"text":"4"},serial=serial)()
ui_steps.click_button(view_to_find={"text":"7"},serial=serial)()
ui_steps.click_button_common(view_to_find={"className":"android.widget.ImageButton"},serial=serial)()

#Tear Down

ui_steps.click_button(view_to_find={"className":"android.widget.ImageButton"},view_to_check={"text":"Phone"},serial=serial)()
