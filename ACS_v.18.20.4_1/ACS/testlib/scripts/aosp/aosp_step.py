...
########################################################################
#
# @filename:    aosp_step.py
# @description: aosp test step
...
class aosp_step(adb_step):
    '''helper class for all aosp test steps
       Refere all wifi step and wifi_steps for more details
    '''
