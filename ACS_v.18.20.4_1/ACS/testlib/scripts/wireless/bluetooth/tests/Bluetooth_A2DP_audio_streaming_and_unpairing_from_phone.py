...
# @usage:       Bluetooth_A2DP_audio_streaming_and_unpairing_from_phone.py -s 0000AAAA
...
try:
    ...
    bluetooth_steps.UnpairDevice(serial=serial_dev,
                                 device_name=DUT_NAME, version=DEV_VERSION)()
    bluetooth_steps.PressHome(serial=serial_dev, critical=False)()
    ui_steps.open_app_from_allapps(serial=serial_dev, view_to_find={"text": "Play Music"})()
