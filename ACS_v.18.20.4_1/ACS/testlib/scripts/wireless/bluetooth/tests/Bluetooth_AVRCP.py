...
# @usage:       Bluetooth_AVRCP.py -s 0000AAAA
#               --script-args serial2 action_dut=Pair and AVRCP profile Testcases
...
action_values = ["Pair","Metadata","Adjustvolumefromphone","Metadataafterreboot",
                 "Pauseandresumefromphone","Switchnextpreviousfromivi","Switchnextpreviousfromphone"]
...
if "action_initiator" in args.keys():
    if args["action_initiator"] in action_values:
        ...
        raise Exception("Possible values for action_values: " + str(action_values))
...
try:
    ...
    if action_initiator=="Metadata":
        ...
        ui_steps.click_button_common(serial=serial_dev,view_to_find={"description":"Show navigation drawer"},
                                     view_to_check={"text": "Music library"},optional=True)()
        ui_steps.click_button_common(serial=serial_dev,view_to_find={"text": "Music library"},
                                     view_to_check={"textContains": "SONGS"},optional=True)()
        ui_steps.click_button_common(serial=serial_dev,view_to_find={"textContains": "SONGS"},
                                         view_to_check={"className":"android.widget.LinearLayout"},optional=True)()
        ...
        time.sleep(20)
        ui_steps.wait_for_view_common(serial=serial,view_to_find={"resourceId":
                                                        "com.android.car.media:id/title"})()
        ui_steps.wait_for_view_common(serial=serial,view_to_find={"resourceId":
                                                        "com.android.car.media:id/artist"})()
    if action_initiator=="Adjustvolumefromphone":
        ...
        if not ui_steps.click_button_common(serial=serial_dev,
            ...
            ui_steps.click_button_common(serial=serial_dev,
                                         first_view_to_find={
                                             "resourceId": "com.google.android.music:id/list_context_menu"},
                                         second_view_to_find={"index": "2"}, scroll=False)()
        ui_steps.press_media(serial=serial)()
        ui_steps.click_button_common(serial=serial, view_to_find={"textContains": "Bluetooth Audio"})()
        time.sleep(20)
    ...
    if action_initiator=="Metadataafterreboot":
        ui_steps.open_app_from_allapps(serial=serial_dev, view_to_find={"text": "Play Music"})()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"description": "Show navigation drawer"},
                                     view_to_check={"text": "Music library"}, optional=True)()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"text": "Music library"},
        ...
        ui_steps.wait_for_view_common(serial=serial, view_to_find={"resourceId":
                                                                       "com.android.car.media:id/artist"})()
    if action_initiator=="Pauseandresumefromphone":
        ui_steps.open_app_from_allapps(serial=serial_dev, view_to_find={"text": "Play Music"})()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"description": "Show navigation drawer"},
                                     view_to_check={"text": "Music library"}, optional=True)()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"text": "Music library"},
        ...
        ui_steps.wait_for_view_common(serial=serial, view_to_find={"resourceId":
                                                                       "com.android.car.media:id/artist"})()
        ui_steps.click_button_common(serial=serial_dev,
                                     view_to_find={"resourceId": "com.google.android.music:id/pause"}, scroll=False)()
        time.sleep(5)
        ui_steps.click_button_common(serial=serial_dev,
                                     view_to_find={"resourceId": "com.google.android.music:id/pause"}, scroll=False)()

    if action_initiator == "Switchnextpreviousfromivi":
        ui_steps.open_app_from_allapps(serial=serial_dev, view_to_find={"text": "Play Music"})()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"description": "Show navigation drawer"},
                                     view_to_check={"text": "Music library"}, optional=True)()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"text": "Music library"},
        ...
        ui_steps.click_button_common(serial=serial_dev,
                                     view_to_find={"resourceId": "com.google.android.music:id/pause"}, scroll=False)()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"resourceId": "com.android.car.media:id/next"},
                                     scroll=False)()
        time.sleep(5)
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"resourceId": "com.android.car.media:id/prev"},
                                     scroll=False)()
    if action_initiator == "Switchnextpreviousfromphone":
        ui_steps.open_app_from_allapps(serial=serial_dev, view_to_find={"text": "Play Music"})()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"description": "Show navigation drawer"},
                                     view_to_check={"text": "Music library"}, optional=True)()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"text": "Music library"},
        ...
        ui_steps.click_button_common(serial=serial_dev,
                                     view_to_find={"resourceId": "com.google.android.music:id/pause"}, scroll=False)()
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"resourceId": "com.google.android.music:id/next"},
                                     scroll=False)()
        time.sleep(5)
        ui_steps.click_button_common(serial=serial_dev, view_to_find={"resourceId": "com.google.android.music:id/prev"},
                                     scroll=False)()
finally:
