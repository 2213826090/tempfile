...
#######################################################################
#
# @description: after receiving 1 file success/fail, notification
...
try:
    ...
    # DEV:  wait scan (should be already finished) and remove paired devices
    ...
    count_unsuccessful_received_initial = \
        bluetooth_steps.BtOppGetNotificationNumberUpdate(serial=serial,
                                                         share_type='Received',
    ...
    # Receive one file from another device via BT successfully. Check the notification.
    bluetooth_steps.NavigateToFileInPhotos(serial=serial_dev, local_folder_name=PHOTO_FOLDER, open_video=False,
    ...
    bluetooth_steps.PressHome(serial=serial_dev)()

    bluetooth_steps.OpenNotificationsMenu(serial=serial, version=DUT_VERSION)()
    count_successful_received_file_accept = \
        bluetooth_steps.BtOppGetNotificationNumberUpdate(serial=serial,
                                                         share_type='Received',
                                                         count_successful=True,
                                                         count_unsuccessful=False,
    ...
    count_unsuccessful_received_file_accept = \
        bluetooth_steps.BtOppGetNotificationNumberUpdate(serial=serial,
                                                         share_type='Received',
                                                         count_successful=False,
                                                         count_unsuccessful=True,
    ...
    # Receive one file from another device via BT unsuccessfully. Check the notification.
    bluetooth_steps.NavigateToFileInPhotos(serial=serial_dev, local_folder_name=PHOTO_FOLDER, open_video=False,
                                           bypass_tutorial=False, version=DEV_VERSION)()
    bluetooth_steps.BtOppSharePhotosFile(serial=serial_dev,
                                         server_dut=str(DUT_NAME),
    ...
    bluetooth_steps.OpenNotificationsMenu(serial=serial, version=DUT_VERSION)()
    count_successful_received_file_decline = \
        bluetooth_steps.BtOppGetNotificationNumberUpdate(serial=serial,
                                                         share_type='Received',
                                                         count_successful=True,
                                                         count_unsuccessful=False,
    ...
    count_unsuccessful_received_file_decline = \
        bluetooth_steps.BtOppGetNotificationNumberUpdate(serial=serial,
                                                         share_type='Received',
                                                         count_successful=False,
                                                         count_unsuccessful=True,
    ...
    # In notification, the unsuccessful receive file number should add 1
    bluetooth_steps.BtOppNotificationUpdateCompare(serial=serial, before_value=count_successful_received_file_accept,
                                                   after_value=count_successful_received_file_decline,
                                                   increment=0)()
    bluetooth_steps.BtOppNotificationUpdateCompare(serial=serial, before_value=count_unsuccessful_received_file_accept,
                                                   after_value=count_unsuccessful_received_file_decline,
                                                   increment=1)()
