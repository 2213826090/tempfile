...
######################################################################
#
# @filename:    reconnect_after_device_reboot.py
# @description: Tests the device can reconnect to the same AP after
#               device reboot.
#
# @run example:
#
#            python reconnect_after_device_reboot.py -s 0BA8F2A0
#                                               --script-args
#                                                       mode=n
#                                                       security=wpa_psk
#                                                       encryption=aes
