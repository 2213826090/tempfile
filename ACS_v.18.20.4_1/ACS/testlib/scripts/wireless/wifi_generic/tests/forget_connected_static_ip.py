...
######################################################################
#
# @filename:    forget_connected_static_ip.py
# @description: Validate that Settings application support to forget static IP WiFi connect information
#
#
# @run example:
#
#            python forget_connected_static_ip.py -s 0BA8F2A0
#                                               --script-args
#                                                       ap_name=ddwrt
#                                                       passphrase=test1234
#                                                       dut_security=wpa
