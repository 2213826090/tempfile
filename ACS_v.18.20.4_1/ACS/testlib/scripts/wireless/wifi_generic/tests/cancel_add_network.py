...
######################################################################
#
# @filename:    cancel_add_network.py
# @description: Tests that when canceling add a network the device will
#               not connect to it.
#
# @run example:
#
#            python cancel_add_network.py -s 0BA8F2A0
#                                               --script-args
#                                                       mode=n
#                                                       security=wpa_psk
#                                                       encryption=aes
...
# check the DUT is disconnected and scanning
