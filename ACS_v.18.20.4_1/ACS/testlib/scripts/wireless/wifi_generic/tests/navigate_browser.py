...
urls = ["http://{0}".format(ap_ip),
        "http://{0}/About.htm".format(ap_ip),
        "http://{0}".format(ap_ip)]
titles = ["Info", "About DD-WRT", "Info"]
texts = ["System Information", "There are several different distributions", "System Information"]
