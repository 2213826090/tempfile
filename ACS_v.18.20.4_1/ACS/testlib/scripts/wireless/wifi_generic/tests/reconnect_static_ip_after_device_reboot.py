...
######################################################################
#
# @filename:    reconnect_static_ip_after_device_reboot.py
# @description: Tests that device will auto connect to previous connected
#                   static IP WiFi network after reboot
#
# @run example:
#
#            python reconnect_static_ip_after_device_reboot.py -s 0BA8F2A0
#                                               --script-args
#                                                       ap_name=ddwrt
#                                                       passphrase=test1234
#                                                       dut_security=wpa
