...
######################################################################
#
# @filename:    General_behavior_open_secure_website.py
...
# @run example:
#
#            General_behavior_open_secure_website.py -s 0BA8F2A0
#                                               --script-args
#                                                   mode=bg
#                                                   txpwr=75
#                                                   security=none
...
adb_steps.command(serial=serial, command="am start -a android.intent.action.VIEW -d http://www.tizen.com")()
time.sleep(8)
