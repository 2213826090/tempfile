...
######################################################################
#
# @filename:    auto_disconnect_connect_static_ip.py
# @description: Validate that system can auto connect the previous
#           connected static IP WiFi network after turning off and on WiFi
#
#
# @run example:
#
#            python auto_disconnect_connect_static_ip.py -s 0BA8F2A0
#                                               --script-args
#                                                       ap_name=ddwrt
#                                                       passphrase=test1234
#                                                       dut_security=wpa
