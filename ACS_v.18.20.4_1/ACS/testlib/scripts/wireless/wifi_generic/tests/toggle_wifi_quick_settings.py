...
######################################################################
#
# @filename:    toggle_wifi_quick_settings.py
# @description: Tests if the wifi switch from the Settings menu
#               works correctly.
#
# @run example:
#
#            python toggle_wifi_switch_notification.py -s 0BA8F2A0
#                                               --script-args
#                                                       iterations=12
#                                                       wait_time=5
#
...
wifi_steps.toggle_wifi_quick_settings(serial = serial, wait_time = wait_time, iterations = iterations)()
