...
######################################################################
#
# @filename:    enable_disable_static_ip.py
# @description: Validate that enable and disable Static IP does not
#               impact with AP connecting status
#
#
# @run example:
#
#            python enable_disable_static_ip.py -s 0BA8F2A0
#                                               --script-args
#                                                       ap_name=ddwrt
#                                                       passphrase=test1234
#                                                       dut_security=wpa
...
# modify the Wi-Fi network to disable static IP
wifi_generic_steps.modify_network(serial = serial,
                                  ssid = ddwrt_ap_name,
                                  security = dut_security,
                                  password = ddwrt_ap_pass,
