...
######################################################################
#
# @filename:    connect-and-reload-pages-from-multiple-APs.py
# @description: Configure and connect to multiple APs one after the other. After that check
#               connection stability by pinging and checking connection state and opening the router web page.
#
# @run example:
#
#            connect-and-reload-pages-from-multiple-APs.py -s 0BA8F2A0
#                                               --script-args
#                                                   mode=bg
#                                                   txpwr=75
#                                                   security=none
