...
try:
	...
	vbmeta_corrupted_system_metadata_path = config.get(image_platform, "vbmeta_corrupted_system_metadata")
	vbmeta_corrupted_system_metadata_name = vbmeta_corrupted_system_metadata_path.split("/")[-1]
	fastboot_utils.download_file(url = fastboot_path + vbmeta_corrupted_system_metadata_path, local_filename = "./temp/image/n/img/" + vbmeta_corrupted_system_metadata_name)
	...
	fastboot_steps.flash_image(partition_name = "vbmeta", file_name = "./temp/image/n/img/"+vbmeta_corrupted_system_metadata_name, lock_dut = True, serial = serial)()
