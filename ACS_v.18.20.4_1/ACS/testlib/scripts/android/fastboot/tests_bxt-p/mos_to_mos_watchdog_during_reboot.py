...
######################################################################
#
# @filename:    mos_to_mos_watchdog_during_reboot.py
# @description: Main to main OS kill watchdog.
#
# @run example:
#
#            python mos_to_mos_watchdog_during_reboot.py --serial=A6EC8F70 --script-args
#                                               relay_type=RLY08B
