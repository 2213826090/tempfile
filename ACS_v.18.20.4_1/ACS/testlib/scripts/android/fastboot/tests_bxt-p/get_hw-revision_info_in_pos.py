...
######################################################################
#
# @filename:    get_hw-revision_info_in_pos.py
# @description: Type "fastboot getvar hw-revision" return ""
#
# @run example:
#
#            python get_hw-revision_info_in_pos.py --serial=A6EC8F70 --script-args
#                                               relay_type=RLY08B
...
try:
    ...
    # command = "fastboot getvar hw-revision"
    # result = False
    # r = os.popen(command)
    # info = r.readlines()
    # for line in info:
