...
if platform_name == "bxtp_abl":
	security_steps.minimium_requirement_check_for_pattern(serial = serial, x = 780, y = 350)()

if platform_name == "gordon_peak":
	security_steps.minimium_requirement_check_for_pattern_on_ivio(serial = serial, x = 885, y = 540)()
