...
if (total_account_no >= 2) or (not account_exists) or (account_exists and not account_synced):
    ...
    ui_steps.add_google_account_for_L(serial = serial,
                                ...
                                password = PASSWORD,
                                prefer_sync = True)()
play_games_steps.open_play_games_explore(serial = serial)()
ui_steps.click_button(serial = serial,\
            view_to_find = {"text": "FEATURED"},\
            view_to_check = {"text" : "Play store"})()
play_games_steps.game_has_specific_properties(serial = serial)()

ui_steps.click_button(serial = serial,\
            view_to_find = {"text": "POPULAR"},\
            view_to_check = {"text" : "Explore"})()
play_games_steps.game_has_specific_properties(serial = serial)()

ui_steps.click_button(serial = serial,\
            view_to_find = {"text": "POPULAR MULTIPLAYER"},\
            view_to_check = {"text" : "Explore"})()
play_games_steps.game_has_specific_properties(serial = serial)()
