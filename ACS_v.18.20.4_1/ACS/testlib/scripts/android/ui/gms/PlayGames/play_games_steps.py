...
class open_play_games_settings(ui_step):
    ...
    def check_condition(self):
        self.uidevice(description="Game Profile").exists
...
class open_play_games_inbox(ui_step):
    ...
    def check_condition(self):
        self.uidevice(text = "No quests today!").exists
...
class open_play_games_help(ui_step):
    ...
    def check_condition(self):
        self.uidevice(text = "Request callback").exists
...
class open_play_games_play_now(ui_step):
    ...
    def check_condition(self):
        self.uidevice(text = "Discover new games").exists
...
class go_for_free_game(ui_step):
    ...
    def check_condition(self):
             self.uidevice(text = "FREE").exists
...
class open_play_games_explore(ui_step):
    ...
    def check_condition(self):
        self.uidevice(text = "FEATURED").exists
...
class open_navigation_drawer(ui_step):
    ...
    def check_condition(self):
        self.uidevice(text = "My Games").exists
...
class open_my_games(ui_step):
    ...
    def check_condition(self):
        self.uidevice(text = "RECENT GAMES").exists
...
class open_players(ui_step):
    ...
    def check_condition(self):
        self.uidevice(text = "FOLLOWING").exists
