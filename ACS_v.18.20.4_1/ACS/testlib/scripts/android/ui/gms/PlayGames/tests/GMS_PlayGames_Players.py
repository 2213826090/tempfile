...
play_games_steps.open_players(serial = serial)()
play_games_steps.check_players_properties(serial = serial, check_follow_button = False)()

ui_steps.click_button(view_to_find = {"text" : "YOU MAY KNOW"},
                        view_to_check = {"textContains" : "Got it"})()
play_games_steps.check_players_properties(serial=serial, check_follow_button = True)()
