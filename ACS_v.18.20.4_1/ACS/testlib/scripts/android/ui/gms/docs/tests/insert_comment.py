...
TITLE = "dtr_{0}".format(serial)
CONTENT = "String repl repl string1 strng2 repl"
...
docs_steps.add_new_document(serial = serial,
                            title = TITLE,
                            content = CONTENT)()
# add comment but cancel
docs_steps.insert_comment(serial = serial,
                            title = TITLE,
                            comment = COMMENT,
                            cancel = True)()
# add comment and confirm it
docs_steps.insert_comment(serial = serial,
                            title = TITLE,
                            comment = COMMENT)()
# cleanup
