...
class open_desk_clock_alarm(ui_step):
    ...
    def check_condition(self):
        return self.uidevice.exists(description="Add alarm")
...
class open_desk_clock_stopwatch(ui_step):
    ...
    def check_condition(self):
        return self.uidevice.exists(resourceId="com.android.deskclock:id/stopwatch_time_text")
...
class open_desk_clock_countdown(ui_step):
    ...
    def check_condition(self):
        return self.uidevice.exists(resourceId="com.android.deskclock:id/desk_clock_pager")
...
class open_desk_clock_world_clock(ui_step):
    ...
    def check_condition(self):
        return self.uidevice.exists(description="Cities")
...
class add_countdown_timer(ui_step):
    ...
    def do(self):
        ...
        if ui_utils.view_exists(view_to_find = {"description":"Add Timer"}):
...
class modify_timer(ui_step):
    ...
    def do(self):
        open_desk_clock_countdown(serial = self.serial)()
        if ui_utils.view_exists(view_to_find = {"description":"Cancel"}):
