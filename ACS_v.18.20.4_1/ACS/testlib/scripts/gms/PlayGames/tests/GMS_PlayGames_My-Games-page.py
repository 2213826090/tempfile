...
play_games_steps.open_my_games(serial = serial)()
play_games_steps.my_games_property(serial=serial)()

ui_steps.click_button(serial = serial,\
                    view_to_find = {"text" : "ALL MY GAMES"},\
                    view_to_check = {"textContains" : "Not installed"})()
play_games_steps.my_games_property(serial=serial)()

ui_steps.click_button(serial = serial,\
                    view_to_find = {"text" : "INSTALLED"})()
play_games_steps.my_games_property(serial=serial)()
