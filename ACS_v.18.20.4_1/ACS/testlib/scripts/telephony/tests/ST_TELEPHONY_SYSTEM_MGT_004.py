...
"""
    How to run:
        python ST_TELEPHONY_SYSTEM_MGT_004.py -s device_serial --script-args sim_pin="1234" number="a_phone_number sms_test_content="some_text" iterations=3
"""
...
for i in range(iterations):
    ...
    adb_steps.command(serial = serial,
                     command = "mount -t debugfs none /d")()
    adb_steps.command(serial = serial,
