...
# Testing the IMEI Code through DUT UI
...
#   Verifying that the IMEI Code(s) exists and is(are) valid with the Luhn algorithm check
imeiArray = ["004401521208153", "004401521208161"]
telephony_steps.check_imei_code(serial = serial, imei_code_array = imeiArray)()
telephony_steps.imeiLuhnCheck(serial = serial, imei_code_array = imeiArray)()
