...
def create_binary_file(file_name = "run_gts", zip_file_name = "dist/run_gts-0.1.linux-x86_64.zip"):
    header = '''#!/bin/bash

export TMPDIR=`mktemp -d /tmp/run_gts.XXXXXX`

ARCHIVE=`awk '/^__ARCHIVE_BELOW__/ {print NR + 1; exit 0; }' $0`

tail -n+$ARCHIVE $0 > $TMPDIR/run_gts.zip
export PYTHONPATH=`pwd`
python $TMPDIR/run_gts.zip $@
...
if __name__ == '__main__':
    ...
    setup(
        ...
        py_modules = ['__main__',
                        ...
                        'testlib.base.abstract_step',
                        'testlib.base.abstract_step_utils',
                        'testlib.base.module_configs ',
                        'testlib.utils.relay',
