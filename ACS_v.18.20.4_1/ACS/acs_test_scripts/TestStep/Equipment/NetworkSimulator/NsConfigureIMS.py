...
:summary: This file implements a Test Step which configure IMS service on equipment
...
class NsConfigureIMS(EquipmentTestStepBase):
    def run(self, context):
        ...
        net_sim.configure_ims(self._global_conf.benchConfig)
