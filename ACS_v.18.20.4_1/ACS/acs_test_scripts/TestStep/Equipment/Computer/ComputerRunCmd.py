...
:summary: This file implements Test Step to run a command on a remote computer
:since 04/03/2016
:author: pblunie
"""
...
class ComputerRunCmd(ComputerBase):
    """
    ...
    def run(self, context):
        ...
        result = self._computer.run_cmd(self._pars.cmd, self._pars.timeout)

        context.set_info(self._pars.save_output_to, result["std"])
