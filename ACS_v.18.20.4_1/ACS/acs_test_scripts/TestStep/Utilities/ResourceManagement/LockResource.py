...
:summary: This file implements a Test Step to lock a shared resource
:since:05/27/2014
:author: mcchilax
"""
...
class LockResource(TestStepBase):
    ...
    def run(self, context):
        ...
        """
        super(LockResource, self).run(context)

        self._logger.info("Locking resource: {0}".format(self._pars.resource))
        ...
        shared_resource.wait_resource_is_ready(self._pars.resource, info)
