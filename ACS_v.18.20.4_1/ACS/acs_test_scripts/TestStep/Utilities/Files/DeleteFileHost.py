...
class DeleteFileHost(FileBase):
    """
    Delete a file on PC host
    """
    ...
    def run(self, context):
        ...
        self._logger.info("DeleteFileHost : file = {0}".format(file_path))
        self._computer.delete_host_file(file_path)
