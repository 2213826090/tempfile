...
class SendAdditionalDataToTcr(TestStepBase):
    """
    ...
    def run(self, context):
        ...
        LiveReporting.instance().update_running_tc_info(test_info={self._pars.node_name: {"value": self._pars.data, "unit": self._pars.unit}},
                                                        iteration=iteration)