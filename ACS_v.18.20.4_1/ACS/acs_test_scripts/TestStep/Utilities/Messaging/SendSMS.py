    ...
    def run(self, context):
        ...
        try:
            ...
            if self._pars.expected_result == "FAILED":
                self._logger.info("SMS was not sent as planned")
            else:
                raise
        else:
            if self._pars.expected_result == "FAILED":
                raise DeviceException(DeviceException.SMS_EXCEPTION, "SMS successful but it should have been failed")
