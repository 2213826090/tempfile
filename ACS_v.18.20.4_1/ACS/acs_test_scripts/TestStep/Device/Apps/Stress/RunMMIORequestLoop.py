"""
@summary: This file implements a Test Step to run a shell script stress test which does both aligned/unaligned mmio reads and writes repeatedly for test duration.
            PREREQUISITES:
...
class RunMMIORequestLoop(DeviceTestStepBase):
    def run(self, context):
        ...
        #If anyone enables this in Windows, I assume they will create a DOS batch file to do what loopTA.sh does.
