"""
@summary: This file implements a Test Step to run a shell script that invokes stress app test.
            PREREQUISITES:
...
class RunStressAppTest(DeviceTestStepBase):
    def run(self, context):
        ...
        basename = "run_stressapptest"
        #To make this OS-independent, look for different possible filenames.
        #If anyone enables this in Windows, I assume they will create a DOS batch file to do what run_stressapptest.sh does.
        ...
        args = '%d 900'%(self._pars.duration)
