...
:summary: This file implements a Test Step to stop PnP mode for Pedometer test case
:since: 07/10/2014
:author: matton
"""
...
class StopPedometer(TestStepBase):
    ...
    def run(self, context):
        ...
        self._logger.info('STOP_PEDOMETER')
        ...
        # Disable PnP Mode for Pedometer Test Case
        ...
        msg = "Pedometer mode is stopped on device {0}".format((self._pars.device))
