...
:summary: This file implements a Test Step to install WIFI-EAP certificate on the device
:since:15/03/2013
:author: ssavrim
"""
...
class InstallWifiEapCertificate(WifiBase):
    """
    Install WIFI-EAP certificate on the device
    """
