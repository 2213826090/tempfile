...
:summary: This file implements a Test Step to get WiFi RSSI
:since 03/11/2014
:author: jfranchx
"""
...
class WifiGetRSSI(WifiBase):
    """
    Implements the get RSSI test step for Wifi
    """
    ...
    def run(self, context):
        ...
        self.ts_verdict_msg = "VERDICT: %s stored as {0}".format(current_rssi) % variable_to_set
