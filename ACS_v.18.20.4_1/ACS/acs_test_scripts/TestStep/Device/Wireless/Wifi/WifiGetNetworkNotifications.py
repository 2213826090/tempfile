...
:summary: This file implements a Test Step to get WiFi network notifications
:since 07/08/2014
:author: jfranchx
"""
...
class WifiGetNetworkNotifications(WifiBase):
    """
    Implements the get network notifications test step for Wifi
    """
