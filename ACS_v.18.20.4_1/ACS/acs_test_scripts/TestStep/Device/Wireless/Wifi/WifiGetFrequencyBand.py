...
:summary: This file implements a Test Step to get WiFi frequency band
:since 06/08/2014
:author: jfranchx
"""
...
class WifiGetFrequencyBand(WifiBase):
    """
    Implements the get frequency band test step for Wifi
    """
    ...
    def run(self, context):
        ...
        state = self._api.get_wifi_frequency_band(interface=self._pars.interface)
        if state == "2.4GHz":
            state = "2_4GHZ"
        elif state == "5GHz":
            state = "5GHZ"
