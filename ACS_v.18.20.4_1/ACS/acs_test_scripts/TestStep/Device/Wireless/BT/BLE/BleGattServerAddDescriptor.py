...
:summary: This script implements the TestStep for adding a descriptor to our GATT Server
:since: 8/28/15
:author: mmaraci
"""
...
class BleGattServerAddDescriptor(BleBase):
    """
    ...
    def run(self, context):
        ...
        if (advertise_mode is not False) and (tx_power_level is not False):
            output = self._api.ble_gatt_server_add_descriptor(tx_power_level, advertise_mode,
