...
:summary: This script implements the TestStep for stopping a beacon observer scan activity on enabled Android
        device
:since: 7/30/15
:author: mmaraci
"""
...
class BleStopObserver(BleBase):
    ...
    def run(self, context):
        ...
        self._api.ble_stop_beacon_observer()