...
:summary: This script implements the TestStep for discovering the GATT Services of a server we are connected to
:since: 8/28/15
:author: mmaraci
"""
...
class BleGattClientDiscoverServices(BleBase):
    """
    ...
    def run(self, context):
        ...
        output = self._api.ble_gatt_client_discover_services(self._pars.address)
