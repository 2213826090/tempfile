...
:summary: This script implements the TestStep for stopping a BLE broadcast on enabled Android
        device
:since: 7/30/15
:author: mmaraci
"""
...
class BleStopBroadcasting(BleBase):
    """
    This script implements the TestStep for stopping a BLE broadcast on enabled Android device
    """
