...
:summary: This file implements a Test Step that pairs the DUT with a BT Device
:since:15/03/2013
:author: fbongiax
"""
...
class BtPair(BtBase):
    ...
    def run(self, context):
        ...
        pair_result = self._api.pair_to_device(config.address, config.reconnect, config.accept,
