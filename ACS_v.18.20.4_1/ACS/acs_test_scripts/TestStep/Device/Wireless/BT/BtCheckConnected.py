...
:summary: This file implements a Test Step that checks if a device (address) is connected
:since:15/06/2015
:author: jreynaux
"""
...
class BtCheckConnected(BtBase):
    """
    Implements the test step to check if a device is connected (usually w/ BLE)

    Note that on BLE the 'connected' state is managed at application level, acs agent should handle it.
    """
