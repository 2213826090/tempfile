...
from TestStep.Device.Wireless.BT.BtPairingConfig import PairingConfig


class BtWaitPairing(BtBase):
    """
    ...
    def run(self, context):
        ...
        self._api.wait_for_pairing(config.address, config.reconnect, config.accept, config.pincode, config.passkey,
                                   self._time_out)
