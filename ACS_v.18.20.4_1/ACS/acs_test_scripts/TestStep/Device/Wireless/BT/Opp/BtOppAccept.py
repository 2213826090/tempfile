...
:summary: This file implements a Test Step that Accepts(implicitly) a file via OPP
:since:19/03/2015
:author: mmaraci
"""
...
from acs_test_scripts.Utilities.LocalConnectivityUtilities import opp_accept_file


class BtOppAccept(BtBase):
    """
    Implements the test step to accept incoming files via OPP
    """
