...
:summary: This file implements a Test Step that Start Opp Server
:since:14/11/2014
:author: mcarriex
"""
...
class BtOppServer(BtBase):
    """
    Implements the test step to start OPP Server (need this for windows)
    """
