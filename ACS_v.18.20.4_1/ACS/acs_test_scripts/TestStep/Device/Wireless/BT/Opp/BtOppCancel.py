...
:summary: This file implements a Test Step that Cancels a file via OPP
:since:19/03/2015
:author: mmaraci
"""
...
class BtOppCancel(BtBase):
    """
    Implements the test step to cancel current or outgoing transfers via OPP
    """
