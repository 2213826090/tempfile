...
:summary: Implements test step to wait for a device disconnection
:since:23/10/2014
:author: ymorelx
"""
...
class BtWaitForDisconnection(BtBase):
    """
    Implements test step to wait for a device disconnection
