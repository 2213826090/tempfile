...
:summary: This file implements a Test Step to check cdk no registration
:since 04/04/2015
:author: gcharlex
"""
from acs_test_scripts.TestStep.Device.Wireless.Cellular.CellularBase import CellularBase

class CheckCdkNoRegistration(CellularBase):
    """
    Implements the check cdk state test step for Cellular
    """
