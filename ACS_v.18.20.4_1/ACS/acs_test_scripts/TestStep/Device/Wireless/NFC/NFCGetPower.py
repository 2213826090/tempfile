...
:summary: This file implements a Test Step to get NFC power
:since 05/09/2014
:author: jfranchx
"""
...
class NFCGetPower(NFCBase):
    """
    Implements the get power test step for NFC
    """
