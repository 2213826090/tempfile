...
:summary: This file implements a Test Step to deactivate PDP context on device
:since: 01/08/2014
...
class DeactivateDevicePdp(DeviceTestStepBase):
    def run(self, context):
        ...
        networking_api.deactivate_pdp_context(self._pars.interface, self._pars.check)
