...
:summary: This file implements a Test Step to check the IP protocol used on the
    specified interface
:since: 01/08/2014
...
class CheckDeviceIpProtocol(DeviceTestStepBase):
    def run(self, context):
        ...
        networking_api.check_ip_protocol(self._pars.protocol)
