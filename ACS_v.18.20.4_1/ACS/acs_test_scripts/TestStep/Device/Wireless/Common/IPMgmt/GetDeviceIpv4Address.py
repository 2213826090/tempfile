...
:summary: This file implements a Test Step to get the device IPV4 address
:since: 01/08/2014
...
class GetDeviceIpv4Address(DeviceTestStepBase):
    def run(self, context):
        ...
        ip_addr = networking_api.get_interface_ipv4_address(self._pars.net_interface)
