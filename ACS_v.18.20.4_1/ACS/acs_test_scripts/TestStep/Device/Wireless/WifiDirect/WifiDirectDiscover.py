...
:summary: This file implements the step to configure the WiFi Direct interface on Linux devices.
:since: 2014-08-01
:author: agoeax
...
class WifiDirectDiscover(WifiDirectBase):
    """
    Sets the P2P network interface to discover mode.
    """
    ...
    def run(self, context):
        ...
        self._api.wifi_direct_discover()
