...
class ForceStopMusicPlayer(DeviceTestStepBase):
    ...
    def run(self, context):
        ...
        self._logger.info("ForceStopMusicPlayer - Parameters ----------------------------")
        self._logger.info("ForceStopMusicPlayer - ---------------------------- Parameters")

	self._logger.info("ForceStopMusicPlayer - Force-stop music-player")
