...
class MonitorVideoDecoderErrors(DeviceTestStepBase):
    ...
    def run(self, context):
        ...
        self._logger.info("MonitorVideoDecoderErrors: Run")
        ...
        system_api.start_log_monitoring(device_logger=device_logger, target_messages=video_decoder_error_messages)

        self._logger.info("MonitorVideoDecoderErrors: Done")
