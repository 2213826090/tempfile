...
:summary: This file implements the test Step for getting the value of a GPIO
:since 12/09/2014
:author: dpierrex
"""
...
class GetGpioValue(GpioBase):
    ...
    def run(self, context):
        ...
        self._logger.info("read_gpio {0} value".format(gpio_number))

        status, output = self._gpio_api.get_gpio_value(gpio_nbr=gpio_number)
