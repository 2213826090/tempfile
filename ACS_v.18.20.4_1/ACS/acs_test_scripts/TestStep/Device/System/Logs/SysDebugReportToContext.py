...
:summary: This file implements the Step to write sysdebug reports into the context.
:since: 2014-10-22
:author: emarchan
...
class SysDebugReportToContext(SysDebugBase):
    """
    Push sysdebug report to context.
    """
