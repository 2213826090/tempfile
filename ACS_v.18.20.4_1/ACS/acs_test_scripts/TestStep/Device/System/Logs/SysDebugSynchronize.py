...
:summary: This file implements the Step to sync sysdebug and board event (waits for a given state).
:since: 2014-10-22
:author: emarchan
...
class SysDebugSynchronize(SysDebugBase):
    """
    Synchronize sysdebug
    """
