"""
@summary: This file implements a Test Step to use during Setup, to install
    device-side scripts that are stored in acs_test_scripts/Lib/ShellScripts/<OS>.
...
class InstallScriptsFromLib(DeviceTestStepBase):
    ...
    def run(self, context):
        ...
        dest_path = self.system_api.install_scripts_from_lib(self._pars.relative_source_path, self._pars.timeout)
        context.set_info(self._pars.stored_dest_path, dest_path)
