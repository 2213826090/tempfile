...
:summary: This file implements the Messaging UEcmd for LLP Android device
:since: 25/09/14
:author: mbrisbax
"""
import time
...
from acs_test_scripts.Device.UECmd.UECmdTypes import MSG_DB_PATH_N


class SmsMessaging(SmsMessagingCommon):
    """
    :summary: Messaging UEcommands operations for LLP Android platforms
    ...
    def delete_all_sms(self):
        ...
        self._exec("adb shell sqlite3 %s \"DELETE FROM sms\"" % MSG_DB_PATH_N)
