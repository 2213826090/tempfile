...
:summary: camera implementation for LLP. This UECMD depends on device model to have button coordinates at get_camera_touchcmds.
...
class Camera(CameraCommon, ICamera):
    ...
    def launch(self):
        ...
        Launches the camera.
        """
        self._logger.info("Camera LLP to be launched")
        ...
        self._logger.info("Camera LLP launched")
    ...
    def camera_app_setup(self, camera_app, mode):
        ...
        if self.camera_app == "Android_Intel_Refcam2_v0.9":
            # Set touch command
            _status, self.touchCmds = self._device.get_camera_touchcmds('intel')
            # Set camera package
            self.camera_package = "com.intel.refcam2"
    ...
    def toggle_burst_mode(self):
        ...
        if self.camera_package =="com.intel.refcam2" :
