...
class DoubleTouchAction(UiAction):

    """
    This class implements the I{double touch} action.
    """
    ...
    def _do(self):
        ...
        result = self.get_monkey().double_touch(self.__x, self.__y, self._default_timeout)
