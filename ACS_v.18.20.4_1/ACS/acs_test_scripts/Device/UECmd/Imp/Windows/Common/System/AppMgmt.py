...
:summary: This file implements the application management UECmd for Windows devices.
:since: 18/12/2015
:author: mcarriex
"""
...
class AppMgmt(Base, IAppMgmt):
    ...
    :summary: Application management UEcommands operations
              for Windows platforms using an C{Intent} based communication to the I{DUT}.
    """
