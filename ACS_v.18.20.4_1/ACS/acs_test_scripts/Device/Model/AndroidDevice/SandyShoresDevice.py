...
:organization: INTEL PEG SVE
:summary: This file implements the SandyShores platform
:since: 5/27/2015
:author: ywei16
"""
...
class SandyShoresDevice(IntelDeviceBase):

    """
        SandyShores platform implementation
    """
    ...
    def get_camera_touchcmds(self, target_name=None):
        ...
        # The commented code above is copied from CherryTrail. We need to redefine this for SandyShores.
        _touchCmds = None
        _status = Global.FAILURE
