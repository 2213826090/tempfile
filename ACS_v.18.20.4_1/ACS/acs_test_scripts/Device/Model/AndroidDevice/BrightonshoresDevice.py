...
:summary: This file implements the Brightonshores platform
:since: 10/21/2015
:author: ahkhowaj
"""
...
class BrightonshoresDevice(IntelDeviceBase):

    """
        Brightonshores platform implementation
    """
    ...
    GOOGLE_CAMERA_TOUCHCMDS_7X12 = {
        'change_camera': [740, 1545],
        'select_settings': [646, 890],
        'select_mode': [600, 965],
    ...
    #This dictionary is referred by get_camera_touchcmds which is called from Device/UECmd/Imp/Android/LLP/Multimedia/Camera.py
    #toggle_burst_mode and change_camera in the Camera UEcmd require these coordinates
    INTEL_CAMERA_TOUCHCMDS_7X12 = {
        'change_camera': [1135, 40],
        'select_mode': [625, 1108],
        'select_video': [570, 944],
        'select_imgae': [570, 856],
        'select_burst': [570, 772],
        'take_picture': [356, 1076]
    }
    ...
    def get_camera_touchcmds(self, target_name=None):
        ...
        This function is called from Device/UECmd/Imp/Android/M/Multimedia/Camera.py
        ...
        if target_name == 'intel' and _disp_width == '720':
            _touchCmds = self.INTEL_CAMERA_TOUCHCMDS_7X12
        elif target_name == 'google' and _disp_width == '720':
            _touchCmds = self.GOOGLE_CAMERA_TOUCHCMDS_7X12
        else:
            self._logger.error('Camera API: Display resolution {0}x{1} is not supported in Brightonshores for now.'.format(_disp_width, _disp_height))
