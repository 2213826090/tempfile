...
:summary: This file implements the FlashToolBase class which is generic class used to implement a specific flash tool
:since: 29/07/2013
:author: lbavois
"""
from acs_test_scripts.Device.Module.NDG.Flash.FlashManager.Tool.CmdExecManager import CmdExecManager
...
class FlashToolBase(CmdExecManager):
    ...
    @property
    def flash_user_data(self):
        return self._flash_user_data

    @flash_user_data.setter
    def flash_user_data(self, value):
        self._flash_user_data = value

    @property
    def flash_options(self):
        return self._flash_options

    @flash_options.setter
    def flash_options(self, value):
        self._flash_options = value
