...
from acs_test_scripts.Device.Module.NDG.Flash.FlashManager.FlashManager import FlashManager
...
class BaseFlashModule(IFlashModule, DeviceModuleBase):
    ...
    def __init__(self):
        super(BaseFlashModule, self).__init__()
    ...
    def _collect_flash_device_info(self):
        """
        Collect device info requested for the flash procedure
    ...
    def init(self, flash_input):
        ...
        self.__flash_manager = FlashManager(self.configuration, self.logger)
    ...
    def flash(self, timeout):
        ...
        if flash_result == Global.SUCCESS:
            ...
            # TODO: Update this part accordingly
