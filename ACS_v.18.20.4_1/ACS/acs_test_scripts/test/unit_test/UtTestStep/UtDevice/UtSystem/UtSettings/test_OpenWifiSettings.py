...
from acs_test_scripts.TestStep.Device.System.Settings.OpenWifiSettings import OpenWifiSettings
from unit_test.UtTestStep.UTestTestStepBase import UTestTestStepBase

class OpenWifiSettingsTestCase(UTestTestStepBase):
    ...
    def _create_sut(self, test_step_pars=None):
        ...
        """
        self._sut = OpenWifiSettings(None, None, test_step_pars, mock.Mock())
