...
from acs_test_scripts.TestStep.Device.System.Settings.OpenSecuritySettings import OpenSecuritySettings
from unit_test.UtTestStep.UTestTestStepBase import UTestTestStepBase

class OpenSecuritySettingsTestCase(UTestTestStepBase):
    ...
    def _create_sut(self, test_step_pars=None):
        ...
        """
        self._sut = OpenSecuritySettings(None, None, test_step_pars, mock.Mock())
