...
from acs_test_scripts.TestStep.Device.System.Settings.OpenBluetoothSettings import OpenBluetoothSettings
from unit_test.UtTestStep.UTestTestStepBase import UTestTestStepBase

class OpenBluetoothSettingsTestCase(UTestTestStepBase):
    ...
    def _create_sut(self, test_step_pars=None):
        ...
        """
        self._sut = OpenBluetoothSettings(None, None, test_step_pars, mock.Mock())
