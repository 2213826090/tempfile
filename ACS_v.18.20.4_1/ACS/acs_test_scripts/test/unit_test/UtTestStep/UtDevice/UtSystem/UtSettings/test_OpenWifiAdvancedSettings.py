...
from acs_test_scripts.TestStep.Device.System.Settings.OpenWifiAdvancedSettings import OpenWifiAdvancedSettings
from unit_test.UtTestStep.UTestTestStepBase import UTestTestStepBase

class OpenWifiAdvancedSettingsTestCase(UTestTestStepBase):
    ...
    def _create_sut(self, test_step_pars=None):
        ...
        """
        self._sut = OpenWifiAdvancedSettings(None, None, test_step_pars, mock.Mock())
