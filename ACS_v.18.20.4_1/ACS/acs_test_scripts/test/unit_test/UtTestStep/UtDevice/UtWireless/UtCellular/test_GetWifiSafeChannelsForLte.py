...
from acs_test_scripts.TestStep.Device.Wireless.Cellular.GetWifiSafeChannelsForLte import GetWifiSafeChannelsForLte

class GetBleSafeChannelsForLteTest(GetSafeChannelsForLteTestBase):
    """
    GetSafeChannelsForLteTest - WIFI
    """
    ...
    def _create_sut(self):
        ...
        """
        sut = GetWifiSafeChannelsForLte(None, None, {"WIFI_SAFE_CHANNELS": self._dest_var}, mock.Mock())
