...
from acs_test_scripts.TestStep.Device.Wireless.Cellular.CellularGetPower import CellularGetPower
from UtilitiesFWK.Utilities import TestConst


class CellularGetPowerTest(UTestTestStepBase):
    """
    SetPower test cases
    """
    ...
    def setUp(self):
        ...
        self._dest_var = "cellular_cur_state"
    ...
    def _create_sut(self):
        ...
        """
        sut = CellularGetPower(None, None, {"SAVE_AS": self._dest_var}, mock.Mock())
        self._method = sut._modem_api.get_modem_power_status
        return sut
