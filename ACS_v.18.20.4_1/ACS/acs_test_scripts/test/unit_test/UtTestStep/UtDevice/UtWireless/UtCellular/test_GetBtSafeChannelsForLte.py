...
from acs_test_scripts.TestStep.Device.Wireless.Cellular.GetBtSafeChannelsForLte import GetBtSafeChannelsForLte

class GetBtSafeChannelsForLteTest(GetSafeChannelsForLteTestBase):
    """
    GetSafeChannelsForLteTest - BT
    """
    ...
    def _create_sut(self):
        ...
        """
        sut = GetBtSafeChannelsForLte(None, None, {"BT_SAFE_CHANNELS": self._dest_var}, mock.Mock())
