...
from acs_test_scripts.TestStep.Device.Apps.Core.OpenHomePage import OpenHomePage
from unit_test.UtTestStep.UTestTestStepBase import UTestTestStepBase

class OpenHomePageTestCase(UTestTestStepBase):
    ...
    def _create_sut(self, test_step_pars=None):
        ...
        """
        self._sut = OpenHomePage(None, None, test_step_pars, mock.Mock())
