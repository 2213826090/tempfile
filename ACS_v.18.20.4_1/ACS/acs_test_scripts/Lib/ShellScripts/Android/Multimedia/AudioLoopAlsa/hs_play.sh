...
alsa_amixer -c wm8958audio cset name='SST Byte control' 1,1,1,1,255,0,20,0,0,255,255,255,114,0,12,0,0,3,255,255,3,0,1,0,0,142,0,0 > /dev/null
...
alsa_amixer -c wm8958audio cset name='SST Byte control' 1,2,0,1,3,0,20,0,255,255,255,255,33,0,12,0,1,0,0,3,103,0,0,0,0,0,50,0 > /dev/null 
