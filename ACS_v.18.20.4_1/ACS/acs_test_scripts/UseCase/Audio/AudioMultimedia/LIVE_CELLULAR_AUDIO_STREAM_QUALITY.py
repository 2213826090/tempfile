...
:summary: This file implements the Live Cellular Audio Stream Quality UC
:since: 17/02/2014
:author: jcoutox
"""
import time
...
class LiveCellularAudioStreamQuality(LiveCellularWebBrowsing):

    """
    Live cellular audio streaming quality class.
    """
...
#------------------------------------------------------------------------------
    ...
    def tear_down(self):
        ...
        """
        LiveCellularWebBrowsing.tear_down(self)
