...
class LabAudioQualityAccessoriesChangeVOIP(LabAudioQualityAccessoriesChangeBase):
    """
        AudioComms Audio VOIP Call Accessories Change class.
    """
    ...
    def set_up(self):
        ...
        if self._acc_swap_type in "PHONE_APP_BASED":
    ...
    def run_test(self):
        ...
        while len(self._temp_acc_list_split) > 0:
            ...
            elif "BLUETOOTH" in self._acc_type:
