...
:summary: This file implements check Audio Quality (PESQ) during GSM Voice
...
class LabAudioGsmVcPesq(LabAudioGsmVcBase):

    """
    Lab Audio Gsm Voice Call Mobile Originated Pesq class.
    """
