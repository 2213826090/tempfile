...
class LabAudioWcdmaVcRecordtones(LabAudioWcdmaVcBase):

    """
    Lab Audio Wcdma Voice Call Recording tone class
    """
    ...
    def __init__(self, tc_name, global_config):
        ...
        self._rec_source = str(self._tc_parameters.get_param_value("SOURCE_INPUT"))
        ...
        self._verdict_comment = "Recording tone not detected in the UL signal"
