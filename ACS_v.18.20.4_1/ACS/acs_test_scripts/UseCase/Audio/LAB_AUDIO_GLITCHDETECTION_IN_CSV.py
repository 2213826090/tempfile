...
from acs_test_scripts.UseCase.Audio.LAB_AUDIO_GLITCHDETECTION_IN_BASE import LabAudioGlitchDetectionBase
from acs_test_scripts.Device.UECmd.UECmdTypes import PreferredNetwork

# pylint: disable=E1101


class LabAudioGlitchDetectionInCSV(LabAudioGlitchDetectionBase):
    """
    ...
    def __init__(self, tc_name, global_config):
        ...
        # Call LabAudioGlitchDetectionBase Init function
        LabAudioGlitchDetectionBase.__init__(self, tc_name, global_config)
    ...
    def set_up(self):
        ...
        """
        # Call LabAudioGlitchDetectionBase Init function
        LabAudioGlitchDetectionBase.set_up(self)
    ...
    def run_test(self):
        ...
        Execute the test
        """
        # Call LabAudioGlitchDetectionBase run_test function
        LabAudioGlitchDetectionBase.run_test(self)
        ...
        LabAudioGlitchDetectionBase.__compute_test_verdict__(self, audio_analyzer_result)
    ...
    def tear_down(self):
        ...
        # Call LabAudioGlitchDetectionBase tear_down function
        LabAudioGlitchDetectionBase.tear_down(self)
