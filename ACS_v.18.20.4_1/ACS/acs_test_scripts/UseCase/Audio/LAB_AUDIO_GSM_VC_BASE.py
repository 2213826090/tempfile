...
class LabAudioGsmVcBase(UseCaseBase):
    """
    ...
    def __init__(self, tc_name, global_config):
        ...
        self._band_name = str(self._tc_parameters.get_param_value("CELL_BAND"))
    ...
    def set_up(self):
        ...
        self._ns_2g.set_band(self._band_name)
        ...
        self._vc_2g.set_speech_configuration(self._ns_speech_source)
        ...
        if self._cell_service == "GSM":
            ...
            RegUtil.check_dut_registration_before_timeout(self._ns_2g,
