...
:summary: Energy Management remove charger Use case
...
class LabEmRemoveCHarger(EmUsecaseBase):
    ...
    def __init__(self, tc_name, global_config):
        ...
        self._charger_type = self._tc_parameters.get_param_value("CHARGER_TYPE")
...
#------------------------------------------------------------------------------
    ...
    def set_up(self):
        ...
        # reboot in the wanted os to start the test
        if self._device.get_boot_mode() != self._start_os:
