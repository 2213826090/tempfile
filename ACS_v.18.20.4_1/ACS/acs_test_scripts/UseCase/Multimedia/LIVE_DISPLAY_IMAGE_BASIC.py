...
:summary: This file implements use case to display image basic
:since: 12/02/2014
:author: mmorchex
"""
...
class LiveDisplayImageBasic(UseCaseBase):

    """
    Class Display Image Basic.
    """
...
#------------------------------------------------------------------------------
    def set_up(self):
        ...
        if self.__default_orientation.lower() == 'portrait':
            self.__matching_threshold = 0.9
...
#------------------------------------------------------------------------------
    def run_test(self):
        ...
        if local_image_to_display:
            ...
            screen_shot_uri = self.__image_api.take_screenshot_and_pull_on_host("screen_shot", os.getcwd())
            time.sleep(self._wait_btwn_cmd)
            ...
            if screen_shot_uri:
                ...
                local_image_to_display_resized = Imagecheck.resize_picture(local_image_to_display, screen_shot_width,
                ...
                match = Imagecheck.match_template_in_image(screen_shot_uri, local_image_to_display_resized,
