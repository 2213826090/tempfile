...
:summary: This module implements check of icon in video application
:since: 21/01/14
:author: jcoutox
"""
...
class LiveCheckIconVideo(UseCaseBase):
    """
    ...
    def set_up(self):
        ...
        video_id = self._multimedia_api.get_video_id_from_path(self._video, self._mediaStoreName)
        time.sleep(self._wait_btwn_cmd)
