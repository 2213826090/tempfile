...
:summary: This file implements the Live WIFI WEB BROWSING UC
:since: 29/11/2011
:author: ssavrimoutou
"""
import time
...
class LiveWifiWebBrowsing(LiveWifiBase):
...
#------------------------------------------------------------------------------
    ...
    def set_up(self):
        ...
        if self._webpage_loading_timeout > 0:
            self._phonesystem_api.set_screen_timeout(self._webpage_loading_timeout * 15)
