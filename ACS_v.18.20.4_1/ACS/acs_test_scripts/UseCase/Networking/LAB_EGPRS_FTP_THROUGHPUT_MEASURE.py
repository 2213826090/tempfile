...
:summary: EGPRS FTP UC with data throughput measurement via network simulator
:author: hbian
:since:09/11/2012
"""
...
class LabEgprsFtpThroughputMeasure(LabEgprsBase):

    """
    Lab Egprs ftp test with data throughput measure.
    """
