...
:summary: This file implements the LAB WCDMA IPERF UC
:since: 16/10/2010
:author: ccontreras
"""
...
from acs_test_scripts.Utilities.IPerfUtilities import compute_iperf_verdict, set_iperf_ip_settings, \
    get_iperf_configuration, retrieve_parameters_from_tc_params
from acs_test_scripts.Utilities.CommunicationUtilities import throughput_targets_string


class LabWcdmaIperf(LabWcdmaBase):

    """
    Lab WCDMA iperf test.
    """
