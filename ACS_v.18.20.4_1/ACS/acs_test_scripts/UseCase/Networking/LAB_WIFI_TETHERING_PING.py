...
:summary: This file implements LAB WIFI TETHERING PING UC
:author: szhen11
:since:27/09/2011
"""
...
class LabWifiTetheringPing(LabWifiTetheringBase):
...
#------------------------------------------------------------------------------
    ...
    def run_test(self):
        ...
        # ping lab server which is in WCDMA network from phone2
        time.sleep(self._wait_btwn_cmd)
        packet_loss = self._networking_api2.\
