...
:summary: Use Case GPRS Base for SMOKE and BAT tests.
...
# ------------------------------------------------------------------------------
    def set_up(self):
        ...
        self._ns_data_2g.set_pdtch_coding_scheme(
            self._dl_coding_scheme, self._ul_coding_scheme)
