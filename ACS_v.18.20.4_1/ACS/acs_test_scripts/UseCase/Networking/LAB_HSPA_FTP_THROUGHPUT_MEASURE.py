...
:summary: HSPA FTP UC with data throughput measurement via network simulator
:author: hbian
:since:09/12/2012
"""
...
class LabHspaFtpThroughputMeasure(LabHspaBase):

    """
    Lab Hspa ftp test with data throughput measure.
    """
