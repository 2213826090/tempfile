...
:summary:Use Case WCDMA PDP Context Deactivate and reactivate with ping check Mo.
...
class LabWcdmaPdpDeactivateReactivate(LabWcdmaBase):

    """
    Lab WCDMA PDP Context Deactivate and reactivate with ping check MO
    """
