...
:summary: This file is check the second IMEI and IMEISV info of DSDS device
:since: 25/04/2016
:author: sahoosax
"""
...
class LiveSystemCheckSecondImeiImeisv(UseCaseBase):

    """
    Class check the second IMEI of DSDS device
    """
...
#------------------------------------------------------------------------------
    ...
    def run_test(self):
        ...
        # get second IMEI value from device for SIM Slot#2
        self._device_imei = self._modem_api.get_second_imei(1)
