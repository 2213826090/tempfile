...
:summary: Use Case base for video recording FPS measurement
:since: 20/05/2014
:author: cimihaix
"""
...
class VideoRecordingFPS(UseCaseBase):
    ...
    def run_test(self):
        ...
        res, out = self._device.run_cmd("adb shell rm /sdcard/DCIM/Camera/* 2> /dev/null", 30)
        #print "xxxxxxxxxxxxxxxxx" + out
        #Record new video
        self._device.run_cmd("adb shell uiautomator runtest Performance.jar -c other.VideoRecording", 330)
        ...
        self._device.get_logger().info("Result VideoRecording score : %s MEDIAN", out.group(0))
    ...
    def tear_down(self):
        ...
        :return: tuple of Verdict and comment
        """
        self._device.run_cmd("adb shell rm /sdcard/DCIM/Camera/* 2> /dev/null", 30)
