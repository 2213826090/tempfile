...
class PeopleLaunchTime(UseCaseBase):
    ...
    def set_up(self):
        ...
        #Launch People as user
        self._device.run_cmd("adb shell uiautomator runtest Performance.jar -c other.PeopleLaunch", 120)
    ...
    def run_test(self):
        ...
        res, out = self._device.run_cmd("adb logcat -d | \
                        grep \"Displayed com.android.contacts/.activities.PeopleActivity\" | cut -d ' ' -f5-", 5)
        ...
        self._device.get_logger().info("Result Contacts score : %s MEDIAN", out.group(0))
