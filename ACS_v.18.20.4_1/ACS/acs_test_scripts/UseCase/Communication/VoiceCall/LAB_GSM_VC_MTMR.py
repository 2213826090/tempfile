...
:summary: Use Case GSM Voice Call Mobile Terminated and Released call for SMOKE
          and BAT tests.
:since: 19/08/2010
:author: dgo
"""
...
class LabGsmVcMtMr(LabGsmVcBase):

    """
    Lab Gsm Voice Mobile Terminated Call and Released Call class.
    """
