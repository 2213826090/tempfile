...
:summary: This file implements the WCDMA Voice Call Mobile Terminated / Network release UC
:since: 19/08/2010
:author: ssa
"""
...
class LabWcdmaVcMtNr(LabWcdmaVcBase):

    """
    Lab Wcdma Voice Call MT/NR.
    """
#------------------------------------------------------------------------------
    ...
    def run_test(self):
        ...
        # Check PDP is active
        self._ns_data_3g.check_data_connection_state("PDP_ACTIVE", self._call_setup_time)
