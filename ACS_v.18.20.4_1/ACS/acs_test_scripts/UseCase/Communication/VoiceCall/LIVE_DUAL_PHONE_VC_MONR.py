...
:summary: This file implements the LIVE VC MONR UC.
...
class LiveDualPhoneVcMoNr(LiveDualPhoneVcBase):

    """
    Live Voice Call MO/NR.
    """
    ...
    def __init__(self, tc_name, global_config):
        ...
        if self._phone2 is not None:
            self._phone_number = str(self._phone2.get_phone_number())
