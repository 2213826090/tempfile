...
:summary: WCDMA Mobile Terminated Cell BroadCast SMS  over CS on network simulator
:since: 08/03/2013
:author: hbian
"""
...
class LabWcdmaCbSmsCsMt(LabWcdmaSmsCsBase):

    """
    WCDMA Mobile Terminated cell broadcast SMS over CS on network simulator class.
    """
