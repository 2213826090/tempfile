...
:summary: GSM Mobile Originated SMS over CS on network simulator
:since: 19/08/2010
:author: dgo
"""
...
class LabGsmSmsCsMo(LabGsmSmsCsBase):

    """
    GSM Mobile Originated SMS over CS on network simulator class.
    """
