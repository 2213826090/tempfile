...
:summary: voice call 3G implementation for RS CMU200 cellular network simulator
:since: 05/04/2011
:author: ymorel
"""
...
from acs_test_scripts.Equipment.NetworkSimulators.Cellular.RsCmu200.Wrapper.Tech3G import WVoiceCall3G as W


class VoiceCall3G(IVoiceCall3G):

    """
    Voice Call 3G implementation for RS CMU200
    """
    ...
    def __error_check(self, err, msg):
        ...
        if err < 0:
            ...
            raise TestEquipmentException(err, msg)
        elif err > 0:
