...
class CellCommon(VisaObject):
    ...
    def set_cell_off(self):
        ...
        Turns off the cell
        """
        self._visa.send_command("CALL:OPER:MODE OFF")

    def set_cell_on(self, mimo=None):
        """
        Turns on the cell
        """
        self._visa.send_command("CALL:OPER:MODE CALL")
    ...
    def set_lac(self, lac):
        ...
        """
        self._visa.send_command("CALL:CELL:LACODE " % lac)
    ...
    def get_lac(self):
        ...
        """
        return self._visa.query_command("CALL:CELL:LACODE?")

    def voice_call_network_release(self):
        """
        Releases a voice call.
        """
        self._visa.send_command("CALL:END")
    ...
    def set_mcc(self, code):
        ...
        """
        self._visa.send_command("CALL:MCC %s" % str(code))
    ...
    def set_cell_service(self, service):
        ...
        :type service: str
        :param service: the cell service to set.
        """
        pass
    ...
    def set_cell_power(self, power):
        ...
        :param power: the cell power to set. Possible values:
            ...
            - "GPRS"
            - "EGPRS"
        :TODO the error management
        """
        for cmd in ("CALL:POW:STAT ON", "*CLS", "CALL:POW:AMPL %s" % power):
    ...
    def set_network_mode_of_operation(self, mode):
        ...
        if mode in range(1, 4):
            ...
            self.get_logger().info("Setting the network mode of operation to"
                                   "%s" % mode)
            self._visa.send_command(gpib + mode)
        else:
            raise AcsBaseException(AcsBaseException.INVALID_PARAMETER,
