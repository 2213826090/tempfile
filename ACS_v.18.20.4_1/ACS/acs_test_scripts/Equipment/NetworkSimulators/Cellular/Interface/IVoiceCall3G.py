...
:summary: virtual interface of 3G voice call functionalities for cellular
network simulators
:since: 10/02/2011
:author: ymorel
"""
...
class IVoiceCall3G(object):

    """
    IVoiceCall3G class: virtual interface of 3G voice call functionalities
