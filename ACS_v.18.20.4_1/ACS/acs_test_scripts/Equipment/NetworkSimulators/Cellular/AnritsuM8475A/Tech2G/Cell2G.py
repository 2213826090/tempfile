...
:summary: Cell 2G implementation for Anritsu M8475A using visa interface
:since: 20/03/2015
:author: gcharlex
"""
from acs_test_scripts.Equipment.NetworkSimulators.Cellular.AnritsuM8475A.Tech2G.Data2G import Data2G
...
class Cell2G(ICell2G, CellCommon):

    """
    Cell 2G implementation for Anritsu M8475A
    """
    ...
    def is_dut_registered(self, dut_imsi=None):
        ...
        """
        gpib_cmd = "BTSCONNSTAT? RegistrationCs,{0}".format(self._name)
