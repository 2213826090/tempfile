...
:summary: Cell 3G implementation for Anritsu M8475A using visa interface
:since: 20/03/2015
:author: gcharlex
"""
from acs_test_scripts.Equipment.NetworkSimulators.Cellular.AnritsuM8475A.Tech3G.Data3G import Data3G
...
class Cell3G(ICell3G, CellCommon):

    """
    Cell 3G implementation for Anritsu M8475A
    """
