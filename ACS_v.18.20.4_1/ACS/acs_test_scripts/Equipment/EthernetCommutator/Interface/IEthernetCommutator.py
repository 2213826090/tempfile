...
:summary: Interface file for Ethernet Commutator equipment
:author: apairex
:since: 07/08/2013
"""
...
class IEthernetCommutator(object):

    """
    Class IEthernetCommutator: virtual interface for Ethernet Commutator Equipment
    """
