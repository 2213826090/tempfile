...
class ShellUtils(object):
    ...
    @staticmethod
    def find_files_matching_pattern(search_path, file_pattern, return_all=False):
        found = []
...
if __name__ == "__main__":
    ShellUtils.get_current_dut_time()
    print ShellUtils.get_props_from_cmd_output("getprop | grep ro.product.device")
