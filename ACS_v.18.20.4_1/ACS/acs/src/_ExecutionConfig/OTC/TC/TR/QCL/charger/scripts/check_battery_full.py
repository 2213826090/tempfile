...
wait_time_hours = 6
wait_time_sec = wait_time_hours * 3600
...
validation_menu = [{"Waiting for the battery to be fully charged. Max wait time of {} "
                    "hours.".format(wait_time_hours): wait_for_battery_full},
