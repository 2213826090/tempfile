...
:description: This is a Python UIAutomator script that prints total space for
 an SDcard from Settings app. Before calling this script, make sure that the
 Storage activity of Settings is opened and an SDcard is mounted
:since: 1/28/15
:author: apalkox
"""
...
if d(packageName="com.android.settings").wait.exists(timeout=10000):
    ...
    if not obj.down(text="Erase SD card"):
        obj.drag.to(d.info['displayWidth'] / 2, d.info['displayHeight'] / 2)
