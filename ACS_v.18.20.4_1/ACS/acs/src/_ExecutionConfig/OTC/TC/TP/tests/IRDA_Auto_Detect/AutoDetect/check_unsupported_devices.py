...
@casename:/System_IRDA_Feature/Auto_detect_Negative_Unsupported_devices
@since: 6/9/2015
...
class Check_unsupported_devices(UIATestBase):
    """
    check haclctl -l
    """

    def setUp(self):
        super(Check_unsupported_devices, self).setUp()
        self._test_name = __name__
        print "[Setup]: %s" % self._test_name
    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(Check_unsupported_devices, self).tearDown()
