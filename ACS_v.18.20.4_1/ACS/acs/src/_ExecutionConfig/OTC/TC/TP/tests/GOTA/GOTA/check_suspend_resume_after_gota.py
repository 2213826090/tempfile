...
'''
@summary: test suspend resume after gota
@since: 27/4/2015
...
class SuspendResumeAfterGOTA(UIATestBase):

    def setUp(self):
        super(SuspendResumeAfterGOTA, self).setUp()
    ...
    def tearDown(self):
        ...
        super(SuspendResumeAfterGOTA, self).tearDown()
        self.cfg = None
    def testSuspendResumeAfterGOTA(self):
