...
class CheckGMSLauncher(UIATestBase):
    ...
    def tearDown(self):
        super(CheckGMSLauncher, self).tearDown()
        print "[Teardown]: %s" % self._test_name

    def testCheckGMSLauncher(self):
        """
        Make sure GMS launcher is pre-installed.
        """
