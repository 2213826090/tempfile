'''
@summary: test OEMDefaltLocalProperty after gota
@since: 9/1/2015
...
class TestOEMDefaltLocalProperty(UIATestBase):
    def setUp(self):
        super(TestOEMDefaltLocalProperty, self).setUp()
        ...
        print u
        f = u + 'IRDA_OEM_Customization/local_property_m/'
        print f
    ...
    def tearDown(self):
        ...
        super(TestOEMDefaltLocalProperty, self).tearDown()
        self.wifi = None
    ...
    def TestOEMDefaltLocalProperty(self):
        self.func.setup_connection()
        ...
        g_common_obj.root_on_device()
        self.func.mount_device()
        cmdstr="adb shell getprop | grep ro.product.locale"
        print cmdstr
        cmd=os.popen(cmdstr).read()
        print cmd
        cmd_search=cmd.count('zh')
