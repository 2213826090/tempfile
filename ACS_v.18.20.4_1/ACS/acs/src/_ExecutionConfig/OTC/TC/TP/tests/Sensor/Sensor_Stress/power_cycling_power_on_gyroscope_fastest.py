...
class power_cycling_power_on_gyroscope_fastest(UIATestBase):
    ...
    def tearDown(self):
        ...
        super(power_cycling_power_on_gyroscope_fastest, self).tearDown()


    def test_power_cycling_power_on_gyroscope_fastest(self):
