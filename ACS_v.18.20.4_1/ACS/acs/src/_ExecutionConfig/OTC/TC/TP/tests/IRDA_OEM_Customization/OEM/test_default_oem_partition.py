...
class TestOEM_partition(UIATestBase):
    """
    Testing wifi enable
    """
    def setUp(self):
        super(TestOEM_partition, self).setUp()
    ...
    def tearDown(self):
        ...
        super(TestOEM_partition, self).tearDown()
        self.wifi = None

    def testOEM_partition(self):
        """
        DEfault OEM customization partition
        """
        print "[RunTest] %s" % self.__str__()

        self.oem.check_oem_partition()
