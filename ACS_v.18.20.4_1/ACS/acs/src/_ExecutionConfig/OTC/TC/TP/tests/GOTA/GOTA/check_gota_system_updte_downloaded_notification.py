...
class SystemUpdateDownloadedNotification(UIATestBase):
    """
    @summary: test downloading screen exist in setting
    """
    ...
    def tearDown(self):
        ...
        super(SystemUpdateDownloadedNotification, self).tearDown()
        self.cfg = None
    ...
    def testNotification(self):
        ...
        assert self.gota.wait_gotastatus_to_downloaded()
        self.gota.system_update_downloaded_notification_exist()
