"""
@summary: check haclctl -li audio
@casename:/System_IRDA_Feature/Platform - Audio
@since: 7/8/2015
...
class Check_Platform_Audio(UIATestBase):
    """
    check haclctl -l
    """

    def setUp(self):
        super(Check_Platform_Audio, self).setUp()
        self._test_name = __name__
        print "[Setup]: %s" % self._test_name
    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(Check_Platform_Audio, self).tearDown()
    def testCheckHalctl_audio(self):
        """
