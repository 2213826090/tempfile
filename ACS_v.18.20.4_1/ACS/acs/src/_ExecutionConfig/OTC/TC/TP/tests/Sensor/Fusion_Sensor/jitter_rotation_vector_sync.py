...
class jitter_rotation_vector_sync(UIATestBase):
    ...
    def setUp(self):
        ...
        super(jitter_rotation_vector_sync, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_rotation_vector_sync, self).tearDown()

    def test_jitter_rotation_vector_sync(self):
