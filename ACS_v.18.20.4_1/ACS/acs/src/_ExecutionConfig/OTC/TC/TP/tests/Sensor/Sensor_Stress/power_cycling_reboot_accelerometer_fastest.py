...
class power_cycling_reboot_accelerometer_fastest(UIATestBase):
    ...
    def setUp(self):
        ...
        super(power_cycling_reboot_accelerometer_fastest, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(power_cycling_reboot_accelerometer_fastest, self).tearDown()


    def test_power_cycling_reboot_accelerometer_fastest(self):
