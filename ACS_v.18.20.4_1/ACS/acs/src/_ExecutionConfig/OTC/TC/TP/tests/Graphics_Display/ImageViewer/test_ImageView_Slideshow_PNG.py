...
class ImageView(UIATestBase):
    ...
    def setUpClass(self):
        ...
        push_pics = ['png' + str(i) for i in range(1, 7)]
        for i in push_pics:
            self.photos.deploy_photo_content("content_picture_png", i)
    ...
    def test_ImageView_Slideshow_PNG(self):
        ''' refer TC test_ImageView_Slideshow_PNG
        '''
