...
class jitter_accelerometer_fastest(UIATestBase):
    '''
    calculate the jitter of accelerometer sensor fastest delay time
    '''
    ...
    def setUp(self):
        ...
        super(jitter_accelerometer_fastest, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_accelerometer_fastest, self).tearDown()

    def test_jitter_accelerometer_fastest(self):
