"""
@summary: check
@casename:/System_IRDA_Feature/Platform - Power
@since: 7/8/2015
...
class Check_Platform_Power(UIATestBase):
    """
    check haclctl -l
    """

    def setUp(self):
        super(Check_Platform_Power, self).setUp()
        self._test_name = __name__
        print "[Setup]: %s" % self._test_name
    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(Check_Platform_Power, self).tearDown()
    def testCheck_Platform_Power(self):
        """
