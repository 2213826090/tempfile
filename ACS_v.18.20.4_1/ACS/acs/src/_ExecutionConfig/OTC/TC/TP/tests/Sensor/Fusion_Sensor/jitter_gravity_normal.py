...
class jitter_gravity_normal(UIATestBase):
    '''
    ...
    def setUp(self):
        ...
        super(jitter_gravity_normal, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_gravity_normal, self).tearDown()

    def test_jitter_gravity_normal(self):
