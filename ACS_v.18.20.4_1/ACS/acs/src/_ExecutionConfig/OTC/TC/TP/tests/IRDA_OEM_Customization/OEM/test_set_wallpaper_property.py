...
class TestSetWallpaperProperty(UIATestBase):
    def setUp(self):
        super(TestSetWallpaperProperty, self).setUp()
        ...
        print u
        f = u + 'IRDA_OEM_Customization/wallpaper_property/'
        print f
    ...
    def tearDown(self):
        ...
        super(TestSetWallpaperProperty, self).tearDown()
        self.wifi = None
