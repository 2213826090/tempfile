...
class DownloadGOTAPackageAndAutoRetry(UIATestBase):
    """
    @summary: Test basic GOTA update
    """

    def setUp(self):
        super(DownloadGOTAPackageAndAutoRetry, self).setUp()
    ...
    def tearDown(self):
        ...
        super(DownloadGOTAPackageAndAutoRetry, self).tearDown()
        self.cfg = None

    def testDownloadGOTAPackageAndAutoRetry(self):
        """
