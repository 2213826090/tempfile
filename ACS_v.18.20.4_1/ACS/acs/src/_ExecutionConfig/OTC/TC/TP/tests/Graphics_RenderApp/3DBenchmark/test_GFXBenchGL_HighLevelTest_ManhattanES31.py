...
class GFXBenchGLHighLevelTestManhattanES31Test(RenderAppTestBase):

    @classmethod
    def setUpClass(cls):
        print "[setUpClass]: %s" % cls.__name__
        super(GFXBenchGLHighLevelTestManhattanES31Test, cls).setUpClass()
    ...
    def tearDown(self):
        ...
        self.gfxbench.clean()
        super(GFXBenchGLHighLevelTestManhattanES31Test, self).tearDown()

    @classmethod
    def tearDownClass(cls):
        print "[tearDownClass]: %s" % cls.__name__
        super(GFXBenchGLHighLevelTestManhattanES31Test, cls).tearDownClass()

    def test_GFXBenchGL_HighLevelTest_ManhattanES31_Onscreen(self):
        """
        test_GFXBenchGL_HighLevelTest_ManhattanES31_Onscreen

        Steps:
        1. Launch GFXBench and select "ManhattanES31 Onscreen", then touch "Start" to run.
            The application starts and run without any issue. Check test result, it should be reported, not N/A.
        """
        print "[RunTest]: %s" % self.__str__()
        print """[Step] 1. Launch GFXBench and select "ManhattanES31 Onscreen", then touch "Start" to run.
            The application starts and run without any issue. Check test result, it should be reported, not N/A."""
        self.gfxbench.launch()

        self.gfxbench.run_test_manhattan31_onscreen()

    def test_GFXBenchGL_HighLevelTest_ManhattanES31_Offscreen(self):
        """
        test_GFXBenchGL_HighLevelTest_ManhattanES31_Offscreen

        Steps:
        1. Launch GFXBench and select "ManhattanES31 Offscreen", then touch "Start" to run.
            The application starts and run without any issue. Check test result, it should be reported, not N/A.
        """
        print "[RunTest]: %s" % self.__str__()
        print """[Step] 1. Launch GFXBench and select "ManhattanES31 Offscreen", then touch "Start" to run.
            The application starts and run without any issue. Check test result, it should be reported, not N/A."""
        self.gfxbench.launch()

        self.gfxbench.run_test_manhattan31_offscreen()
