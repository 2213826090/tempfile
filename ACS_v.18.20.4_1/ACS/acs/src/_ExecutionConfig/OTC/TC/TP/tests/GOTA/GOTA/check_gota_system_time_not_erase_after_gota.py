...
class SystemTimeNotEraseAfterGOTA(UIATestBase):
    """
    ...
    def tearDown(self):
        ...
        super(SystemTimeNotEraseAfterGOTA, self).tearDown()
        self.cfg = None

    def testSystemTimeNotEraseAfterGOTA(self):
        """
