...
class TestChangeToAnother(UIATestBase):
    """
    Testing wifi enable
    """
    def setUp(self):
        super(TestChangeToAnother, self).setUp()
    ...
    def tearDown(self):
        ...
        super(TestChangeToAnother, self).tearDown()
        self.wifi = None

    def testChangeAnother(self):
        """
        Change OEM wallpaper to another
        """
        ...
        self.oem.launch_wallpaper()
        self.oem.change_wallpaper(3, "end.png")
