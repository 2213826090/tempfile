...
class Render(RenderAppTestBase):
    ...
    def test_rsmiscsamples_rsList(self):
        ''' refer TC test_RsMiscSamples_RsList
        '''
        print "[RunTest]: %s" % self.__str__()
        self._render.launch_miscsamples_list_am()
        self._render.scroll_to_bottom()
        self._render.stop_miscsamples_list_am()
