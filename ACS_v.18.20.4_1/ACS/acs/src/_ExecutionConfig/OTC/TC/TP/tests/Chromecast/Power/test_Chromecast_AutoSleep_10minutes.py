...
class ChromeCast(UIATestBase):
    ...
    def setUp(self):
        ...
        self._settings.set_screen_off_timeout(600000)
    ...
    def test_chromecast_autosleep_10minutes(self):
        ''' refer TC test_Chromecast_AutoSleep_10minutes
        '''
        self._chromecast.sleep_time(610)
