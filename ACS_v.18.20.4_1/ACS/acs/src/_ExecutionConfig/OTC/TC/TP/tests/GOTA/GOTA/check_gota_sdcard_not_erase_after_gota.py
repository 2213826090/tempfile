...
'''
@summary: test sdcard data is not erased after GOTA update
@since: 12/4/2014
...
class SDcardNotEraseAfterGOTA(UIATestBase):
    """
    @summary: Test sdcard data is not erased after GOTA update
    """

    def setUp(self):
        super(SDcardNotEraseAfterGOTA, self).setUp()
    ...
    def tearDown(self):
        ...
        super(SDcardNotEraseAfterGOTA, self).tearDown()
        self.cfg = None

    def testSDcardNotEraseAfterGOTA(self):
        """
        ...
        Test Case Step:
        1. push some file into sdcard
        2. process GOTA update
        3. check the file is not erased after GOTA 
        ...
        assert self.system.file_exists(sdcard_file, "DEVICE"), "[ERROR]: The client file %s does not exist" % sdcard_file
