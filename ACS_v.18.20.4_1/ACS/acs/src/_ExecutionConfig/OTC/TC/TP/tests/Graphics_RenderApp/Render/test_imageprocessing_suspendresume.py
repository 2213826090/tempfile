...
class RunImageProcessing(RenderAppTestBase):
    ...
    def setUp(self):
        ...
        self._runimageprocessing = ImageProcessingTest(\
            self.config.read(cfg_file, "imageprocessing"))
    ...
    def imageprocessing_suspend_resume(self):
        self._runimageprocessing.launch_app_am()
        self._runimageprocessing.scroll_to_bottom()
        self._runimageprocessing.slider_saturation()
        self._runimageprocessing.slider_inblack()
        self._runimageprocessing.sleep_wakeup()
        self._runimageprocessing.slider_outblack()
        self._runimageprocessing.slider_outwhite1()
        self._runimageprocessing.sleep_wakeup()
        self._runimageprocessing.slider_outwhite2()
        self._runimageprocessing.sleep_wakeup()
