...
class frequency_gyroscope_fastest(UIATestBase):
    ...
    def setUp(self):
        ...
        super(frequency_gyroscope_fastest, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(frequency_gyroscope_fastest, self).tearDown()

    def test_frequency_gyroscope_fastest(self):
        ...
        cfg = self.config.read(self.cfg_file,'frequency_gyroscope_fastest')
        ...
        for loop in range(10):
            ...
            self.sensorImpl.logger.info("Loop %d/10 frequency_gyroscope_fastest" %(loop+1))
