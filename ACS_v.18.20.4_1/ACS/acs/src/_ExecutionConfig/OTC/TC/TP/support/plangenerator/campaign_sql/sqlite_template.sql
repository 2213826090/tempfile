select distinct test.test_id, test.domain, test.name test_name, test.tag ,test.subject,test.priority test_priority, test.automation_fw,req.requirement_id, req.e_feature_id_broxton_p_ivi_m, jira.status jira_status, jira.priority jira_priority
...
WHERE         jira.android_version != ''
              ...
              and (test.applicable_android_release = '' or test.applicable_android_release like '%M%')
