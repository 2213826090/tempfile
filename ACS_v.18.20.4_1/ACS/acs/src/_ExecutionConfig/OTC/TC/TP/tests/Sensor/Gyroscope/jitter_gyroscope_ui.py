...
class jitter_gyroscope_ui(UIATestBase):
    '''
    calculate the jitter of gyroscope sensor ui delay time
    '''
    ...
    def setUp(self):
        ...
        super(jitter_gyroscope_ui, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_gyroscope_ui, self).tearDown()

    def test_jitter_gyroscope_ui(self):
