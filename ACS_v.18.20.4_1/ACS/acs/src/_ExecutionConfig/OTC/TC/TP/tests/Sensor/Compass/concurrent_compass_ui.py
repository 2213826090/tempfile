...
class concurrent_compass_ui(UIATestBase):
    ...
    def setUp(self):
        ...
        super(concurrent_compass_ui, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(concurrent_compass_ui, self).tearDown()

    def test_concurrent_compass_ui(self):
        ...
        cfg = self.config.read(self.cfg_file,'concurrent_compass_ui')
        ...
        for loop in range(10):
            ...
            self.sensorImpl.logger.info("Loop %d/10 concurrent_compass_ui" %(loop+1))
