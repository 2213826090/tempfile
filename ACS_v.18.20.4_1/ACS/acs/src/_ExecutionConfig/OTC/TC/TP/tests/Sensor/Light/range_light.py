...
class range_light(UIATestBase):
    ...
    def test_range_light(self):
        ...
        for loop in range(10):
            ...
            self.sensorImpl.logger.info("Loop %d/10 range_light" %(loop+1))
