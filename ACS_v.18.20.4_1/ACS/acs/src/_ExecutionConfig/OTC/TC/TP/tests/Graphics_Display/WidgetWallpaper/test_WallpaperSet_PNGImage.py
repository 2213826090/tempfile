...
class WallpaperSetPNGImageTest(UIATestBase):

    @classmethod
    def setUpClass(cls):
        print "[setUpClass]: %s" % cls.__name__
        super(WallpaperSetPNGImageTest, cls).setUpClass()
    ...
    def setUp(self):
        ...
        super(WallpaperSetPNGImageTest, self).setUp()
...
#         self.wallpaper.reset_wallpaper()
        ...
        self.qrcode = cfg.get("wallpaperset_png_qrcode")
        print "[Debug] qrcode:%s" % (self.qrcode)
        arti = Artifactory(cfg_arti.get('location'))
        pic_name = cfg.get("wallpaperset_png_image")
...
#             "occurred Fatal error during testing:\n%s" % (fatal_msg)
        super(WallpaperSetPNGImageTest, self).tearDown()
        remove_aosp_launcher()

    @classmethod
    def tearDownClass(cls):
        print "[tearDownClass]: %s" % cls.__name__
        super(WallpaperSetPNGImageTest, cls).tearDownClass()
