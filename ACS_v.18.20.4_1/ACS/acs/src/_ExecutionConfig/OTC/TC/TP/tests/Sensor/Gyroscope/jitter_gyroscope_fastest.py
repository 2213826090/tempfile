...
class jitter_gyroscope_fastest(UIATestBase):
    '''
    calculate the jitter of gyroscope sensor fastest delay time
    '''
    ...
    def setUp(self):
        ...
        super(jitter_gyroscope_fastest, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_gyroscope_fastest, self).tearDown()

    def test_jitter_gyroscope_fastest(self):
