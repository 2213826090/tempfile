...
'''
@summary: test camera function after gota
@since: 20/5/2015
...
class CheckCameraAfterGOTA(UIATestBase):

    def setUp(self):
        super(CheckCameraAfterGOTA, self).setUp()
    ...
    def tearDown(self):
        ...
        super(CheckCameraAfterGOTA, self).tearDown()
        self.cfg = None
    def testCheckCameraAfterGOTA(self):
