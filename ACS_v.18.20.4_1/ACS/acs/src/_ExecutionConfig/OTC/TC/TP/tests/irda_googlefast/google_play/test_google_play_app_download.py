...
class GooglePlayAppDownloadTest(UIATestBase):
    """
    @summary: Test google play application
    """
    def setUp(self):
        cfg_file = 'tests.tablet.google_fast.conf'
        super(GooglePlayAppDownloadTest, self).setUp()
    ...
    def tearDown(self):
        super(GooglePlayAppDownloadTest, self).tearDown()
        print "[Teardown]: %s" % self._test_name

    def testGooglePlayAppDownload(self):
        """
        ...
        self.googleplay.google_play_app_download()
