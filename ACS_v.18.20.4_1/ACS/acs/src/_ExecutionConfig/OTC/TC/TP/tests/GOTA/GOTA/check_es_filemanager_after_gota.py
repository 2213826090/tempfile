...
'''
@summary: test es filemanager app after gota
@since: 20/5/2015
...
class CheckESfilemanagerAfterGOTA(UIATestBase):

    def setUp(self):
        super(CheckESfilemanagerAfterGOTA, self).setUp()
    ...
    def tearDown(self):
        ...
        super(CheckESfilemanagerAfterGOTA, self).tearDown()
        self.cfg = None
    def testCheckESfilemanagerAfterGOTA(self):
        print "[RunTest]: %s" % self.__str__()
        self.gota.unlock_screen_gota()
        self.gota.launch_es_filemanager_app()
