...
class TestOEMDefaltLocale(UIATestBase):
    """
    Testing wifi enable
    """
    def setUp(self):
        super(TestOEMDefaltLocale, self).setUp()
        ...
        print u
        f = u + 'IRDA_OEM_Customization/oem_local/'
        print f
    ...
    def tearDown(self):
        ...
        super(TestOEMDefaltLocale, self).tearDown()
        self.wifi = None
