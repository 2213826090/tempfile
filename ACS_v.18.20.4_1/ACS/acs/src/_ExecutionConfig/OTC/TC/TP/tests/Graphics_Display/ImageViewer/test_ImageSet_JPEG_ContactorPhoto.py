...
class SetContactorPhoto(UIATestBase):
    ...
    def tearDown(self):
        ...
        try:
            self._setAccount.delete_account("TEST_JPEG")
        except:
            print "account was not removed in tearDown."
        self.photos.rm_delete_photos()

    def test_setJPEG_ContactorPhoto(self):
        self._setAccount.launch_app_am()
        self._setAccount.create_account("TEST_JPEG")
        self._setAccount.stop_app_am()
        self.photos.launch_photos_am()
        self.photos.open_a_picture()
        self.photos.set_picture_as_contact_photo("TEST_JPEG")
        self.photos.stop_photos_am()
        self._setAccount.launch_app_am()
        self._setAccount.check_setphoto("TEST_JPEG", "U1H56IKT4C")
        self._setAccount.stop_app_am()
