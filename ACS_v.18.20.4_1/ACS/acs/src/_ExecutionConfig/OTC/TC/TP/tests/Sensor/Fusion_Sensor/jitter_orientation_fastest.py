...
class jitter_orientation_fastest(UIATestBase):
    '''
    ...
    def setUp(self):
        ...
        super(jitter_orientation_fastest, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_orientation_fastest, self).tearDown()

    def test_jitter_orientation_fastest(self):
