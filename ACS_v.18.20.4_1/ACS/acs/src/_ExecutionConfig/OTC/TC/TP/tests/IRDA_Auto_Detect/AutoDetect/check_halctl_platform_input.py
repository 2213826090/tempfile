"""
@summary: check
@casename:/System_IRDA_Feature/Platform - Input
@since: 7/8/2015
...
class Check_Platform_Input(UIATestBase):
    """
    check haclctl -l
    """

    def setUp(self):
        super(Check_Platform_Input, self).setUp()
        self._test_name = __name__
        print "[Setup]: %s" % self._test_name
        self.hal = AutodetectImpl()
    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(Check_Platform_Input, self).tearDown()
        self.hal =None
    def testCheck_Platform_Input(self):
        """
