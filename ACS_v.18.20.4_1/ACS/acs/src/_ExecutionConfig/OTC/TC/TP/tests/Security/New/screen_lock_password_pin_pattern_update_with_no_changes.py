...
class ScreenLockPasswdPinPatternUpdateNoChanges(UIATestBase):
    ...
    def tearDown(self):
        ...
        super(ScreenLockPasswdPinPatternUpdateNoChanges, self).tearDown()

    def test_screen_lock_password_pin_pattern_update_no_changes(self):
