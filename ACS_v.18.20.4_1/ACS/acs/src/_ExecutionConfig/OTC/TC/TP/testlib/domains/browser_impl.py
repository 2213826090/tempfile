...
#--------- begin locator -------------
    class Locator(object):
        ...
        def btn_chrome_accept(self):
            ...
            return self.d(textContains = "Accept", \
        ...
        def btn_app_name(self):
            ...
            return self.d(resourceId="com.android.settings:id/app_name", \
            text="Chrome")
        ...
        def btn_force_stop(self):
            ...
            return self.d(resourceId="com.android.settings:id/left_button", \
            text="Force stop")
    ...
    activityname = "com.google.android.apps.chrome.ChromeTabbedActivity"
    ...
    def clear_data(self):
        ...
        self._locator.btn_force_stop.click()
    ...
    def input_in_browser(self, input_key):
        """ input in browser """
        print "[INFO] Test input in Browser"
        self.browser_setup()
        assert self._locator.btn_url_bar.exists, \
        "[FAILURE] Launched Chrome Failed"
        self._locator.btn_url_bar.set_text(input_key)
