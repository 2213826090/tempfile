...
class jitter_accelerometer_sync(UIATestBase):
    ...
    def setUp(self):
        ...
        super(jitter_accelerometer_sync, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_accelerometer_sync, self).tearDown()

    def test_jitter_accelerometer_sync(self):
