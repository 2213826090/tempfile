...
class jitter_linear_accelerometer_fastest(UIATestBase):
    '''
    calculate the jitter of linear accelerometer sensor fastest delay time
    '''
    ...
    def setUp(self):
        ...
        super(jitter_linear_accelerometer_fastest, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_linear_accelerometer_fastest, self).tearDown()

    def test_jitter_linear_accelerometer_fastest(self):
