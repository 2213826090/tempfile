"""
@summary: check
@casename:/System_IRDA_Feature/Platform - Sensors
@since: 7/8/2015
...
class Check_Platform_Sensor(UIATestBase):
    """
    check haclctl -l
    """

    def setUp(self):
        super(Check_Platform_Sensor, self).setUp()
        self._test_name = __name__
        print "[Setup]: %s" % self._test_name
    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(Check_Platform_Sensor, self).tearDown()
    def testCheck_Platform_Sensor(self):
        """
