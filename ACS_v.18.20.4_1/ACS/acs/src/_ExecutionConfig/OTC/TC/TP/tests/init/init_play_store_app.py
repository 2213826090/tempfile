...
class InitPlayStore(UIATestBase):
    ...
    def setUp(self):
        ...
        self.retry_num = self.config.read(cfg_file,'init_list').get("init_play_store_app")
    ...
    def tearDown(self):
        super(InitPlayStore, self).tearDown()
        print "[Teardown]: %s" % self._test_name

    def testInitPlayStore(self):
        """
        Init Play Store App
        """
