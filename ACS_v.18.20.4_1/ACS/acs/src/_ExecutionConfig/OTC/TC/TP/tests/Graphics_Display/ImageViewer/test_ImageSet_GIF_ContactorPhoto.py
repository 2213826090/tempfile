...
class SetContactorPhoto(UIATestBase):
    ...
    def setUpClass(self):
        ...
        self.photos.deploy_photo_content("qrcode_marked_image", "imageviewing_image")
    ...
    def tearDown(self):
        ...
        try:
            self._setAccount.delete_account("TEST_GIF")
        except:
            print "account was not removed in tearDown."
        self.photos.rm_delete_photos()

    def test_setGIF_ContactorPhoto(self):
        self._setAccount.launch_app_am()
        self._setAccount.create_account("TEST_GIF")
        self._setAccount.stop_app_am()
        self.photos.launch_photos_am()
        self.photos.open_a_picture()
        self.photos.set_picture_as_contact_photo("Test")
        self.photos.stop_photos_am()
        self._setAccount.launch_app_am()
        self._setAccount.check_setphoto("TEST_GIF", "L1RTRAWDAG")
        self._setAccount.stop_app_am()
