...
class concurrent_compass_normal(UIATestBase):
    ...
    def setUp(self):
        ...
        super(concurrent_compass_normal, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(concurrent_compass_normal, self).tearDown()

    def test_concurrent_compass_normal(self):
        ...
        cfg = self.config.read(self.cfg_file,'concurrent_compass_normal')
        ...
        for loop in range(10):
            ...
            self.sensorImpl.logger.info("Loop %d/10 concurrent_compass_normal" %(loop+1))
