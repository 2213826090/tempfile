...
class jitter_orientation_ui(UIATestBase):
    '''
    ...
    def setUp(self):
        ...
        super(jitter_orientation_ui, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_orientation_ui, self).tearDown()

    def test_jitter_orientation_ui(self):
