...
class GOTAUpdate(UIATestBase):
    """
    @summary: Test basic GOTA update
    """

    def setUp(self):
        super(GOTAUpdate, self).setUp()
    ...
    def tearDown(self):
        ...
        super(GOTAUpdate, self).tearDown()
        self.cfg = None

    def testGOTAUpdate(self):
        """
        ...
        after_ota_info_file="~/ota/"+"afterOTA_"+tmp_name+".log"
        self.gota.basic_gota_update()
        self.gota.adb_shell_getprop_to_file()
