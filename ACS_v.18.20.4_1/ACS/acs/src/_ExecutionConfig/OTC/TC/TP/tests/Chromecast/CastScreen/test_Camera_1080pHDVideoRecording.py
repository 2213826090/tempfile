...
class Camera1080pHDVideoRecordingTest(ChromeCastTestBase):

    @classmethod
    def setUpClass(cls):
        print "[setUpClass]: %s" % cls.__name__
        super(Camera1080pHDVideoRecordingTest, cls).setUpClass()

    def setUp(self):
        print "[Setup]:%s" % self.__class__.__name__
        super(Camera1080pHDVideoRecordingTest, self).setUp()
    ...
    def tearDown(self):
        ...
        self.camera.clean()
        super(Camera1080pHDVideoRecordingTest, self).tearDown()

    @classmethod
    def tearDownClass(cls):
        print "[tearDownClass]: %s" % cls.__name__
        super(Camera1080pHDVideoRecordingTest, cls).tearDownClass()

    def test_Camera_1080pHDVideoRecording(self):
        """
        test_Camera_1080pHDVideoRecording
        ...
        4. Take some HD 1080p video files using Camera app.
            The HD 1080p video files are taken and screencasting has no degradation.
        """
        ...
        print """[Step] 4. Take some HD 1080p video files using Camera app.
            The HD 1080p video files are taken and screencasting has no degradation."""
        self.camera.setVideoTo1080p()
