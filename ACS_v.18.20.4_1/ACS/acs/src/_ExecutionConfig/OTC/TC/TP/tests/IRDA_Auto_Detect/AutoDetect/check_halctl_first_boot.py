"""
@summary: check boot dmesg after first flash image
@casename:/System_IRDA_Feature/Auto_detect First Boot
@since: 11/11/2014
...
class Check_Halctl_FirstBoot(UIATestBase):
    ...
    def setUp(self):
        super(Check_Halctl_FirstBoot, self).setUp()
    ...
    def tearDown(self):
        ...
        super(Check_Halctl_FirstBoot, self).tearDown()
        self.cfg = None
        self.hal=None
