...
class ImageEdit(UIATestBase):
    ...
    def test_imageedit_rotaterightmorethan6times(self):
        ''' refer TC test_ImageEdit_RotateRightMoreThan6times
        '''
        print "[RunTest]: %s" % self.__str__()
        self.photos.launch_photos_am()
        self._imageviewer.open_photo_and_rotate_right_7times()
