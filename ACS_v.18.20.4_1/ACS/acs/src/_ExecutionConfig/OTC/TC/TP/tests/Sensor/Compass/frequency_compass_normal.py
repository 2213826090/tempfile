...
class frequency_compass_normal(UIATestBase):
    ...
    def setUp(self):
        ...
        super(frequency_compass_normal, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(frequency_compass_normal, self).tearDown()

    def test_frequency_compass_normal(self):
        ...
        cfg = self.config.read(self.cfg_file,'frequency_compass_normal')
        ...
        for loop in range(10):
            ...
            self.sensorImpl.logger.info("Loop %d/10 frequency_compass_normal" %(loop+1))
