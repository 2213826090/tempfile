...
class jitter_gyroscope_game(UIATestBase):
    '''
    calculate the jitter of gyroscope sensor game delay time
    '''
    ...
    def setUp(self):
        ...
        super(jitter_gyroscope_game, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_gyroscope_game, self).tearDown()

    def test_jitter_gyroscope_game(self):
