...
class jitter_rotation_vector_fastest(UIATestBase):
    '''
    calculate the jitter of rotation vector sensor fastest delay time
    '''
    ...
    def setUp(self):
        ...
        super(jitter_rotation_vector_fastest, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_rotation_vector_fastest, self).tearDown()

    def test_jitter_rotation_vector_fastest(self):
