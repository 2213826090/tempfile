...
class ImageProcessingGenGPUTest(RenderAppTestBase):

    @classmethod
    def setUpClass(cls):
        print "[setUpClass]: %s" % cls.__name__
        super(ImageProcessingGenGPUTest, cls).setUpClass()
    ...
    def setUp(self):
        ...
        super(ImageProcessingGenGPUTest, self).setUp()
    ...
    def tearDownClass(cls):
        ...
        super(ImageProcessingGenGPUTest, cls).tearDownClass()

    def test_ImageProcessing_GenGPU(self):
        """
        test_ImageProcessing_GenGPU

        Steps:
        1. Launch ImageProcessing.
            The application starts and run without issues. Check message like “Computer Device: GPU” in logcat
        ...
        # Not found GPU message in logcat
        # self.imageprocessing.verify_log_gen_gpu(time_mark)
