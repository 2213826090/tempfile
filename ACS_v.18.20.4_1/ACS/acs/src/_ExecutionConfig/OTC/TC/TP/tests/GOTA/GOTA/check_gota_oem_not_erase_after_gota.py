...
class OEMNotEraseAfterGOTA(UIATestBase):
    """
    @summary: Test sdcard data is not erased after GOTA update
    """

    def setUp(self):
        super(OEMNotEraseAfterGOTA, self).setUp()
    ...
    def tearDown(self):
        ...
        super(OEMNotEraseAfterGOTA, self).tearDown()
        self.cfg = None

    def testOEMNotEraseAfterGOTA(self):
        """
        ...
        assert self.system.file_exists(oem_file, "DEVICE"), "[ERROR]: The client file %s does not exist after gota" % oem_file
