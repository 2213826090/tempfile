...
class range_orientation(UIATestBase):
    ...
    def setUp(self):
        ...
        super(range_orientation, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(range_orientation, self).tearDown()

    def test_range_orientation(self):
        '''
        check the max range of orientation
        '''
        ...
        cfg = self.config.read(self.cfg_file,'range_orientation')
        ...
        for loop in range(10):
            ...
            self.sensorImpl.logger.info("Loop %d/10 range_orientation" %(loop+1))
