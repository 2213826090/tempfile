...
class frequency_gyroscope_game(UIATestBase):
    ...
    def setUp(self):
        ...
        super(frequency_gyroscope_game, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(frequency_gyroscope_game, self).tearDown()

    def test_frequency_gyroscope_game(self):
        ...
        cfg = self.config.read(self.cfg_file,'frequency_gyroscope_game')
        ...
        for loop in range(10):
            ...
            self.sensorImpl.logger.info("Loop %d/10 frequency_gyroscope_game" %(loop+1))
