...
class frequency_compass_ui(UIATestBase):
    ...
    def setUp(self):
        ...
        super(frequency_compass_ui, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(frequency_compass_ui, self).tearDown()

    def test_frequency_compass_ui(self):
        ...
        cfg = self.config.read(self.cfg_file,'frequency_compass_ui')
        ...
        for loop in range(10):
            ...
            self.sensorImpl.logger.info("Loop %d/10 frequency_compass_ui" %(loop+1))
