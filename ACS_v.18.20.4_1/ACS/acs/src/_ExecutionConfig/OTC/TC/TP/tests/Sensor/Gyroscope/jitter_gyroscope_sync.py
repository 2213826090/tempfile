...
class jitter_gyroscope_sync(UIATestBase):
    ...
    def setUp(self):
        ...
        super(jitter_gyroscope_sync, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(jitter_gyroscope_sync, self).tearDown()

    def test_jitter_gyroscope_sync(self):
