...
class accelerometer_longlasting_streaming(UIATestBase):
    ...
    def setUp(self):
        ...
        super(accelerometer_longlasting_streaming, self).setUp()

    def tearDown(self):
        print "[Teardown]: %s" % self._test_name
        super(accelerometer_longlasting_streaming, self).tearDown()


    def test_accelerometer_longlasting_streaming(self):
