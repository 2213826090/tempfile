...
class NomalRelay08ACS(object):
    ...
    def __init__(self, relay08):
        ...
        if self.relay08.get_bench_params().has_parameter("SwitchOnOff"):
            self.power = self.relay08.get_bench_params().get_param_value("SwitchOnOff")
        else:
            self.power = None
        if self.relay08.get_bench_params().has_parameter("RelayCutter"):
            self.usb = self.relay08.get_bench_params().get_param_value("RelayCutter")
        elif self.relay08.get_bench_params().has_parameter("USBVCCut"):
            self.usb = self.relay08.get_bench_params().get_param_value("USBVCCut")
        else:
            self.usb = None
