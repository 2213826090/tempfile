...
class TestSetLanguageProperty(UIATestBase):
    def setUp(self):
        super(TestSetLanguageProperty, self).setUp()
        ...
        print u
        f = u + 'IRDA_OEM_Customization/language_property/'
        print f
    ...
    def tearDown(self):
        ...
        super(TestSetLanguageProperty, self).tearDown()
        self.wifi = None
    ...
    def TestsetLanguageproperty(self):
        self.func.setup_connection()
        ...
        g_common_obj.root_on_device()
        self.func.mount_device()
        cmdstr="adb shell getprop | grep ro.product.locale.language"
        print cmdstr
