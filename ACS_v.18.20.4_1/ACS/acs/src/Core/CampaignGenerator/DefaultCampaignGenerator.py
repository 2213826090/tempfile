...
:summary: Implement default ACS campaign generator
:since: 07/07/2015
:author: sfusilie
"""
import os
...
from Core.CampaignConf import CampaignConf
from Core.CatalogParser.CatalogParser import CatalogParser
from Core.PathManager import Paths
from Core.Report.ACSLogging import LOGGER_FWK
from Core.TestCaseConf import TestCaseConf
