...
from UtilitiesFWK.Utilities import CAST_TYPE_DICTIONARY, str_to_bool
...
class TestStepParameters(object):
    ...
    def replace_static_pars_refs(self, tc_parameters, global_conf):
        ...
        :type tc_parameters: :py:class:`~src.Core.TCParameters`
    ...
    def replace_dynamic_pars_refs(self, context):
        ...
        :type context: :py:class:`~src.Core.TestStep.TestStepContext`
