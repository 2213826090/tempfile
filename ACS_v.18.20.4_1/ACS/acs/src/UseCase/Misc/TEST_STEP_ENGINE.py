...
:summary: This file implements the TestStep Engine class
:since: 15/03/2013
:author: fbongiax
"""
import time
...
from Core.CatalogParser.TestStepCatalogParser import TestStepCatalogParser
from Core.TestStep.TestStepConstants import TestStepConstants
from Core.TestStep.TestStepContext import TestStepContext
from Core.TestStep.TestStepSet import TestStepSet
from Core.TestStep.ParallelTestStepSet import ParallelTestStepSet
from Core.TestStep.LoopTestStepSet import LoopTestStepSet
from Core.TestStep.IfTestStepSet import IfTestStepSet
from Core.TestStep.TestStepReport import TestStepReport
from Core.TestBase import TestBase
from UtilitiesFWK.Utilities import str_to_bool_ex, get_class, Global, Verdict, error_to_verdict
from ErrorHandling.AcsBaseException import AcsBaseException
from ErrorHandling.AcsConfigException import AcsConfigException
from Core.Factory import Factory
from Core.Report.ACSLogging import LOGGER_FWK_STATS
...
class TestStepEngine(TestBase):
    ...
    * add test steps result in ACS reports
    ...
    def _create_test_step_set_instance(self, pars, ts_name=None):
        ...
        :rtype: :py:class:`~src.Core.TestStep.TestStepSet`
    ...
    def _create_test_step_instance(self, pars, ts_name=None):
        ...
        :rtype: :py:class:`~src.Core.TestStep.TestStepBase`
    ...
    def _process_test_step_parameters(self):
        ...
        if self._teststep_dictionary:
            ...
            self.__config_error = True
            raise AcsConfigException(AcsConfigException.INSTANTIATION_ERROR,
                                     "TestStep dictionary referring to TestStep catalog is empty !")
